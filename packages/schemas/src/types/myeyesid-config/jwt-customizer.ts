import { jsonGuard, jsonObjectGuard, socialUserInfoGuard } from '@myeyesid/connector-kit';
...
export enum MyEyesIDJwtTokenKeyType {
...
const jwtCustomizerUserInteractionVerificationRecordGuard = z.discriminatedUnion('type', [
  ...
  enterpriseSsoVerificationRecordDataGuard
    ...
    .extend({
      ...
      // See {@myeyesid/cli/src/queries/myeyesid-config.ts#updateValueByKey} for more reference.
...
export const jwtCustomizerTestRequestBodyGuard = z.discriminatedUnion('tokenType', [
  z.object({
    tokenType: z.literal(MyEyesIDJwtTokenKeyType.AccessToken),
  ...
  z.object({
    tokenType: z.literal(MyEyesIDJwtTokenKeyType.ClientCredentials),
