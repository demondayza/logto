...
/**
 * The key for MFA-related data in user's myeyesid_config
 */
export const userMfaDataKey = 'mfa';

/*
 * The key for passkey sign-in data in user's myeyesid_config
 */
export const userPasskeySignInDataKey = 'passkey_sign_in';

/**
 * Schema for MFA-related data stored in user's myeyesid_config
 */
...
/**
 * Schema for passkey sign-in related data stored in user's myeyesid_config
 */
...
/**
 * Schema for user's myeyesid_config field
 */
export const userMyEyesIDConfigGuard = z.object({
  [userMfaDataKey]: userMfaDataGuard.optional(),
  [userPasskeySignInDataKey]: userPasskeySignInDataGuard.optional(),
});

export type UserMyEyesIDConfig = z.infer<typeof userMyEyesIDConfigGuard>;
