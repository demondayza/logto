...
const sign_in_exp = {
  ...
  color: {
    ...
    dark_mode_description:
      'سيحتوي تطبيقك على نمط وضع داكن مولد تلقائيًا بناءً على لون العلامة التجارية الخاصة بك وخوارزمية MyEyesID. يمكنك تخصيصه بحرية.',
  ...
  custom_ui: {
    ...
    bring_your_ui_description:
      'قم بتحميل حزمة مضغوطة (.zip) لاستبدال واجهة المستخدم المُعدة مسبقًا في MyEyesID بالشفرة الخاصة بك. <a>تعلم المزيد</a>',
