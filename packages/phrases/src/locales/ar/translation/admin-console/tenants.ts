const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      'اختر المكان الذي سيتم استضافة المستأجر الخاص بك فيه. اختر MyEyesID Cloud للبنية التحتية العامة المشتركة ، أو مثيل خاص للحصول على موارد مخصصة.',
    ...
    development_description:
      'للاختبار فقط ويجب ألا يستخدم في الإنتاج. لا يلزم اشتراك. لديه جميع الميزات المهنية ولكن لديه قيود مثل لافتة تسجيل الدخول.',
    ...
    enterprise_sso_description:
      'متاح في الخطط المدفوعة. اتصل بنا لتمكين Enterprise SSO حتى يتمكن جميع الأعضاء من تسجيل الدخول إلى MyEyesID Cloud Console باستخدام موفر هوية مؤسستك.',
  },
  full_env_tag: {
    development: 'تطوير',
    production: 'إنتاج',
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'قم بتخصيص معرف المستأجر. إذا ترك فارغًا، سيقوم MyEyesID بإنشاء معرف افتراضي. لا يمكن تغيير معرف المستأجر بعد الإنشاء.',
  },
  ...
  tenant_landing_page: {
    ...
    description:
      'لبدء تكوين مشروعك باستخدام MyEyesID ، يرجى إنشاء مستأجر جديد. إذا كنت بحاجة إلى تسجيل الخروج أو حذف حسابك ، فقط انقر فوق زر الصورة الرمزية في الزاوية اليمنى العلوية.',
