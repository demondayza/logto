const domain = {
  ...
  update_endpoint_notice:
    'لا تنسى تحديث النطاق لعنوان URI لموصل الشبكة الاجتماعية ونقطة النهاية الخاصة بـ MyEyesID في تطبيقك إذا كنت ترغب في استخدام نطاق مخصص للميزات.',
  ...
  custom: {
    ...
    deletion: {
      ...
      in_used_tip:
        'إذا قمت بإعداد هذا النطاق المخصص في موفر موصل الشبكة الاجتماعية أو نقطة النهاية التطبيقية الخاصة بك من قبل ، فسيتعين عليك تعديل عنوان URI إلى النطاق الافتراضي لـ MyEyesID "<span>{{domain}}</span>" أولاً. هذا ضروري لعمل زر تسجيل الدخول الاجتماعي بشكل صحيح.',
  ...
  default: {
    ...
    default_domain_description:
      'يوفر MyEyesID نطاقًا افتراضيًا معينًا مسبقًا ، جاهزًا للاستخدام دون أي إعدادات إضافية. يعمل هذا النطاق الافتراضي كخيار احتياطي حتى إذا قمت بتمكين نطاق مخصص.',
    default_domain_field: 'النطاق الافتراضي لـ MyEyesID',
  },
