const roles = {
  ...
  title: 'الأدوار',
  subtitle:
    'تتضمن الأدوار الأذونات التي تحدد ما يمكن للمستخدم القيام به. يستخدم RBAC الأدوار لمنح المستخدمين الوصول إلى الموارد لإجراءات محددة.',
  create: 'إنشاء دور',
  role_name: 'اسم الدور',
  role_type: 'نوع الدور',
  type_user: 'مستخدم',
  ...
  placeholder_description:
    'الأدوار هي مجموعة من الأذونات التي يمكن تعيينها للمستخدمين. تأكد من إضافة الأذونات أولاً قبل إنشاء الأدوار.',
  assign_roles: 'تعيين الأدوار',
  management_api_access_notification:
    'للوصول إلى واجهة برمجة تطبيقات إدارة MyEyesID، حدد الأدوار ذات الأذونات لواجهة برمجة التطبيقات <flag/>.',
  with_management_api_access_tip:
    'يتضمن هذا الدور من الجهاز إلى الجهاز أذونات واجهة برمجة تطبيقات إدارة MyEyesID',
