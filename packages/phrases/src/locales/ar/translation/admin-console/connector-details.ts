const connector_details = {
  ...
  settings_description:
    'دمج موفري الطرف الثالث لتسهيل تسجيل الدخول السريع بالوسائل الاجتماعية وربط الحسابات الاجتماعية',
  setting_description_with_token_storage_supported:
    'دمج موفري الطرف الثالث لتسهيل تسجيل الدخول السريع بالوسائل الاجتماعية وربط الحسابات الاجتماعية والوصول إلى API.',
  email_connector_settings_description:
    'التكامل مع موفر توصيل البريد الإلكتروني الخاص بك لتمكين تسجيل الدخول والتسجيل بالبريد الإلكتروني بدون كلمة مرور للمستخدمين النهائيين.',
