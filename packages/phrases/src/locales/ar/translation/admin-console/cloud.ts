const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'المستأجر هو بيئة معزولة حيث يمكنك إدارة هويات المستخدمين والتطبيقات وجميع الموارد الأخرى في MyEyesID.',
    invite_collaborators: 'ادعو مشاركيك عبر البريد الإلكتروني',
  },
  social_callback: {
    title: 'لقد قمت بتسجيل الدخول بنجاح',
    description:
      'لقد قمت بتسجيل الدخول بنجاح باستخدام حسابك الاجتماعي. لضمان التكامل السلس والوصول إلى جميع ميزات MyEyesID، نوصي بمتابعة تكوين موصلك الاجتماعي الخاص بك.',
    notice:
