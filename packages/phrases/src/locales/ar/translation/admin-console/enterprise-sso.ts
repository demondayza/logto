const enterprise_sso = {
  ...
  placeholder_description:
    'لقد قدمت MyEyesID العديد من موفري هوية المؤسسة المدمجة للاتصال، في الوقت نفسه يمكنك إنشاء موفر خاص بك باستخدام بروتوكولات SAML و OIDC.',
  create_modal: {
  ...
  basic_info: {
    ...
    oidc: {
      ...
      redirect_uri_field_custom_domain_description:
        'إذا كنت تستخدم عدة <a>نطاقات مخصصة</a> في MyEyesID، فتأكد من إضافة جميع عناوين URI لرد الاتصال المقابلة إلى موفر الهوية لديك لضمان عمل تسجيل الدخول الأحادي (SSO) عبر كل نطاق.\n\nيظل نطاق MyEyesID الافتراضي (*.myeyesid.app) صالحًا دائمًا؛ قم بتضمينه فقط إذا كنت ترغب أيضًا في دعم SSO ضمن ذلك النطاق.',
    },
  },
  attribute_mapping: {
    title: 'تعيين السمات',
    ...
    col_sp_claims: 'قيمة موفر الخدمة (MyEyesID)',
