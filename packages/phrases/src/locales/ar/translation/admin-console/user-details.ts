const user_details = {
  ...
  suspend_user_reminder:
    'هل أنت متأكد أنك تريد تعليق هذا المستخدم؟ لن يتمكن المستخدم من تسجيل الدخول إلى تطبيقك ولن يتمكن من الحصول على رمز الوصول الجديد بعد انتهاء الحالي. بالإضافة إلى ذلك ، ستفشل أي طلبات API التي يقوم بها هذا المستخدم.',
  ...
  sessions: {
    title: 'الجلسات',
    description:
      'إدارة الجلسات التي تحتفظ بها خادم التفويض MyEyesID. إلغاء جلسة MyEyesID هنا يمنع الموافقة التلقائية على طلبات التفويض المستقبلية.',
    field_name: 'الجلسات',
    multiple_signed_in: 'قام هذا المستخدم بتسجيل الدخول إلى عدة أجهزة أو متصفحات.',
    not_found: 'لم يتم العثور على جلسات MyEyesID نشطة. المستخدم ليس مسجلاً حاليًا في أي جهاز.',
    name_column: 'الاسم',
