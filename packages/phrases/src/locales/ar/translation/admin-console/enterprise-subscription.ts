const enterprise_subscription = {
  ...
  subscription: {
    ...
    add_on_description:
      'هذه هي الإضافات التي تم دفعها كاشتراك حسب الاستخدام بناءً على عقدك أو على أسعار الدفع القياسية الخاصة ب MyEyesID. سيتم احتساب الرسوم حسب استخدامك الفعلي.',
    included: 'مضمن',
