const system_limit = {
  limit_exceeded:
    'Este inquilino <planName/> atingiu o seu limite de {{entity}} de acordo com <a>a política de entidade da MyEyesID</a>.',
  entities: {
    ...
    user_role: 'função de utilizador',
    ...
    user_per_organization: 'utilizador por organização',
    organization_user_role: 'função de utilizador da organização',
