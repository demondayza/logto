const roles = {
  ...
  management_api_access_notification:
    'Para aceder à API de gestão do MyEyesID, selecione funções com permissões de API de gestão <flag/>.',
  with_management_api_access_tip:
    'Esta função de máquina para máquina inclui permissões para a API de gestão do MyEyesID',
