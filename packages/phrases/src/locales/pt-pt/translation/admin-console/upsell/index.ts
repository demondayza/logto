...
const upsell = {
  ...
  token_exceeded_modal: {
    ...
    notification:
      'Você excedeu o limite de uso de tokens do seu <planName/>. Os utilizadores não poderão aceder ao serviço MyEyesID corretamente. Por favor, atualize seu plano para premium prontamente para evitar qualquer inconveniência.',
  },
