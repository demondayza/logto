const quota_table = {
  ...
  application: {
    ...
    third_party: 'Aplicações de terceiros OIDC/OAuth',
    saml_app: 'Aplicações SAML',
  },
  resource: {
  ...
  support: {
    ...
    discord_private_channel: 'Canal privado do Discord',
    premium_support: 'Suporte premium',
    developer_onboarding: 'Integração de desenvolvedor',
    solution_engineer_support: 'Engenheiro de soluções',
    sla: 'SLA',
    dedicated_computing_resources: 'Recursos computacionais dedicados',
  },
  compliance: {
    title: 'Conformidade',
    soc2_compliant: 'Conformidade com SOC2',
  ...
  mau_tip:
    'MAU (utilizadores ativos mensais) significa o número de utilizadores únicos que trocaram pelo menos um token com o MyEyesID num ciclo de faturação.',
  tokens_tip:
    'Todos os tipos de tokens emitidos pelo MyEyesID, incluindo token de acesso, token de atualização, etc.',
  mao_tip:
  ...
  third_party_tip:
    'Utilize o MyEyesID como o seu fornecedor de identidade OIDC para inícios de sessão de aplicações de terceiros e outorga de permissões.',
