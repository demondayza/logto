...
const subscription = {
  ...
  free_plan_description:
    'Para projetos secundários e testes iniciais do MyEyesID. Sem cartão de crédito.',
  pro_plan: 'Plano Pro',
  pro_plan_description: 'Para empresas que desejam se beneficiar sem preocupações com o MyEyesID.',
  ...
  payment_error:
    'Problema de pagamento detectado. Não é possível processar ${{price, number}} para o ciclo anterior. Atualize o pagamento para evitar a suspensão do serviço MyEyesID.',
  downgrade: 'Downgrade',
  current: 'Atual',
  upgrade: 'Atualização',
  quota_table,
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      'Estás atualmente a utilizar mais do que o permitido pelo <name />. O MyEyesID é agora oficial, incluindo funcionalidades adequadas a cada plano. Antes de considerares a atualização para o <name />, certifica-te de que preenches os seguintes critérios antes de proceder à atualização.',
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      'Estás quase a atingir o limite de utilização do token. O MyEyesID deixará de conceder tokens se a tua utilização exceder 100%. Por favor, faz upgrade do plano Gratuito para evitar qualquer inconveniente.',
    dev_plan_exceeded:
      'Este inquilino atingiu o limite de tokens de acordo com a política de limite de entidade do MyEyesID.',
  },
};
