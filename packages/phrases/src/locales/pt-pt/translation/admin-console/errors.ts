const errors = {
  ...
  invalid_parameters_format: 'Formato inválido de parâmetros',
  ...
  create_internal_role_violation:
    'Está a criar uma nova função interna que é proibida pelo MyEyesID. Tente outro nome que não comece com "#internal:".',
