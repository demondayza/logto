const enterprise_subscription = {
  ...
  subscription: {
    ...
    add_on_description:
      'Estes são add-ons pagas conforme o uso, com base no teu contrato ou nas taxas padrão paga conforme o uso da MyEyesID. Serás cobrado de acordo com o teu uso real.',
    included: 'Incluído',
