const organizations = {
  ...
  guide: {
    ...
    introduction: {
      title: 'Vamos entender como uma organização funciona na MyEyesID',
      section_1: {
      ...
      section_2: {
        ...
        description:
          'Nas aplicações SaaS multi-inquilinos, muitas organizações frequentemente partilham o mesmo modelo de controlo de acesso, que inclui permissões e funções. Na MyEyesID, chamamos-lhe "modelo de organização."',
      ...
      section_3: {
        ...
        description:
          'Sim, pode atribuir permissões de API a papéis de organização. O MyEyesID oferece a flexibilidade para gerir eficazmente os papéis da sua organização, permitindo incluir tanto permissões de organização como permissões de API nesses papéis.',
      },
      section_4: {
