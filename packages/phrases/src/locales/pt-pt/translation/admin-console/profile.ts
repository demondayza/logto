const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'Apagar a sua conta irá remover permanentemente todos os dados sobre você na MyEyesID Cloud. Por isso, assegure-se de fazer backup de quaisquer dados importantes antes de continuar.',
      confirm_information:
    ...
    try_again_later:
      'Por favor, tente novamente mais tarde. Se o problema persistir, contacte a equipa da MyEyesID com o ID do pedido.',
  ...
  mfa: {
    ...
    section_description:
      'Adicione uma camada extra de segurança à sua conta usando uma aplicação de autenticação, uma chave de acesso ou códigos de backup.',
    two_step_verification: 'Verificação em 2 passos',
