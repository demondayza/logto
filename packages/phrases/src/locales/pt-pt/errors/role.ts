const role = {
  ...
  internal_role_violation:
    'Você pode estar tentando atualizar ou excluir uma função interna que é proibida pelo MyEyesID. Se você estiver criando uma nova função, tente outro nome que não comece com "#internal:". ',
};
