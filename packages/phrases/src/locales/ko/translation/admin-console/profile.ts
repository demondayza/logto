const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        '계정을 삭제하면 MyEyesID Cloud 에서 당신에 대한 모든 데이터가 영구적으로 삭제돼요. 중요한 데이터를 백업해주세요.',
      confirm_information:
    ...
    try_again_later:
      '나중에 다시 시도해주세요. 문제가 지속되면 요청 ID 와 함께 MyEyesID 팀에 문의하세요.',
  ...
  mfa: {
    title: '이중 인증',
    section_description:
      '인증 앱, 패스키 또는 백업 코드를 사용하여 계정에 추가적인 보안을 더하세요.',
    two_step_verification: '2단계 인증',
    not_configured: '구성되지 않음',
    configured: '구성됨',
    passkeys_count_one: '{{count}}개의 패스키',
    passkeys_count_other: '{{count}}개의 패스키',
    backup_codes_count_one: '{{count}}개의 백업 코드 사용 가능',
    backup_codes_count_other: '{{count}}개의 백업 코드 사용 가능',
    add: '추가',
    view: '보기',
    remove: '삭제',
  },
