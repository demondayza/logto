const roles = {
  ...
  management_api_access_notification:
    'Para acessar a API de gerenciamento do MyEyesID, selecione funções com permissões de API de gerenciamento <flag/>.',
  with_management_api_access_tip:
    'Esta função de máquina para máquina inclui permissões para a API de gerenciamento do MyEyesID',
