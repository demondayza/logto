const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'Excluir sua conta removerá permanentemente todos os dados sobre você na MyEyesID Cloud. Portanto, certifique-se de fazer backup de quaisquer dados importantes antes de prosseguir.',
      confirm_information:
    ...
    try_again_later:
      'Por favor, tente novamente mais tarde. Se o problema persistir, entre em contato com a equipe MyEyesID com o ID da solicitação.',
  ...
  mfa: {
    ...
    section_description:
      'Adicione uma camada extra de segurança à sua conta usando um aplicativo autenticador, uma chave de acesso ou códigos de backup.',
    two_step_verification: 'Verificação em 2 etapas',
    not_configured: 'Não configurado',
    configured: 'Configurado',
    passkeys_count_one: '{{count}} chave de acesso',
    passkeys_count_other: '{{count}} chaves de acesso',
    backup_codes_count_one: '{{count}} código disponível',
    backup_codes_count_other: '{{count}} códigos disponíveis',
    add: 'Adicionar',
    view: 'Ver',
    remove: 'Remover',
  },
