const quota_table = {
  ...
  support: {
    ...
    discord_private_channel: 'Canal privado no Discord',
    premium_support: 'Suporte premium',
    developer_onboarding: 'Integração de desenvolvedores',
    solution_engineer_support: 'Engenheiro de soluções',
    sla: 'SLA',
    dedicated_computing_resources: 'Recursos de computação dedicados',
  },
  compliance: {
    title: 'Conformidade',
    soc2_compliant: 'Conformidade SOC2',
  ...
  mau_tip:
    'MAU (usuários ativos mensais) significa o número de usuários únicos que trocaram pelo menos um token com o MyEyesID em um ciclo de faturamento.',
  tokens_tip:
  ...
  third_party_tip:
    'Use MyEyesID como seu provedor de identidade OIDC para logins e concessões de permissão de aplicativos de terceiros.',
