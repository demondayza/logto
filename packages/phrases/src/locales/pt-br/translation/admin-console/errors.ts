const errors = {
  ...
  invalid_parameters_format: 'Formato de parâmetros inválido',
  ...
  create_internal_role_violation:
    'Você está criando uma nova função interna que é proibida pela MyEyesID. Tente outro nome que não comece com "#internal:".',
