const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Um inquilino é um ambiente isolado onde você pode gerenciar identidades de usuário, aplicações e todos os outros recursos do MyEyesID.',
    invite_collaborators: 'Convide seus colaboradores por e-mail',
  },
  social_callback: {
    title: 'Você entrou com sucesso',
    description:
      'Você entrou com sucesso usando sua conta social. Para garantir a integração perfeita e o acesso a todos os recursos do MyEyesID, recomendamos que você prossiga para configurar seu próprio conector social.',
    notice:
