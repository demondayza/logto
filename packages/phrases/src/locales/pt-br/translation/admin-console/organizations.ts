const organizations = {
  ...
  guide: {
    ...
    introduction: {
      title: 'Vamos entender como a organização funciona no MyEyesID',
      section_1: {
      ...
      section_2: {
        ...
        description:
          'Em aplicativos SaaS multi-inquilino, várias organizações frequentemente compartilham o mesmo modelo de controle de acesso, que inclui permissões e papéis. No MyEyesID, chamamos isso de "modelo de organização".',
      ...
      section_3: {
        ...
        description:
          'Sim, você pode atribuir permissões de API a funções de organização. A MyEyesID oferece flexibilidade para gerenciar as funções da sua organização de forma eficaz, permitindo que você inclua tanto as permissões da organização quanto as permissões de API nessas funções.',
      },
      section_4: {
