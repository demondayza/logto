const enterprise_subscription = {
  ...
  subscription: {
    ...
    add_on_description:
      'Estes são complementos pay-as-you-go adicionais baseados no seu contrato ou nas tarifas padrão pay-as-you-go do MyEyesID. Você será cobrado de acordo com o seu uso real.',
    included: 'Incluído',
