const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Un tenant è un ambiente isolato in cui puoi gestire identità degli utenti, applicazioni e tutte le altre risorse di MyEyesID.',
    invite_collaborators: 'Invita i tuoi collaboratori via email',
  },
  social_callback: {
    title: 'Accesso effettuato con successo',
    description:
      "Hai effettuato l'accesso con successo utilizzando il tuo account social. Per garantire integrazione senza problemi e accesso a tutte le funzionalità di MyEyesID, ti consigliamo di procedere alla configurazione del tuo connettore social.",
    notice:
