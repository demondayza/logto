...
const upsell = {
  ...
  create_tenant: {
    ...
    description:
      'MyEyesID offre opzioni competitive di piani con una struttura dei prezzi innovativa e conveniente progettata per le aziende in crescita. <a>Scopri di più</a>',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      'Il tuo MAU attuale ha superato il limite di <planName/>. Aggiorna al piano premium tempestivamente per evitare la sospensione del servizio MyEyesID.',
    update_plan: 'Aggiorna piano',
  },
  token_exceeded_modal: {
    title: 'Utilizzo dei token ha superato il limite. Aggiorna il tuo piano.',
    notification:
      'Hai superato il limite di utilizzo dei token <planName/>. Gli utenti non saranno in grado di accedere correttamente al servizio MyEyesID. Si prega di aggiornare tempestivamente il proprio piano a premium per evitare qualsiasi inconveniente.',
  },
  payment_overdue_modal: {
    title: 'Pagamento della fattura in ritardo',
    notification:
      "Oops! Il pagamento della fattura dell'affittuario <span>{{name}}</span> è fallito. Si prega di pagare tempestivamente la fattura per evitare la sospensione del servizio MyEyesID.",
  ...
  charge_notification_for_quota_limit:
    "Hai superato il limite di quota {{item}}. MyEyesID aggiungerà addebiti per l'uso oltre il limite di quota. La fatturazione inizierà il giorno in cui verrà rilasciato il nuovo design dei prezzi dell'addon. <a>Ulteriori informazioni</a>",
  paywall,
