const enterprise_subscription = {
  ...
  subscription: {
    ...
    add_on_description:
      'Questi sono componenti aggiuntivi a consumo basati sul tuo contratto o sulle tariffe standard a consumo di MyEyesID. Ti verrà addebitato in base al tuo utilizzo effettivo.',
    included: 'Incluso',
