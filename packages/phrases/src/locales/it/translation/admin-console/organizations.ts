const organizations = {
  ...
  guide: {
    ...
    introduction: {
      title: "Capire come funziona l'organizzazione in MyEyesID",
      section_1: {
      ...
      section_2: {
        ...
        description:
          'Nelle applicazioni SaaS multi-inquilino, spesso più organizzazioni condividono lo stesso modello di controllo degli accessi, che include permessi e ruoli. In MyEyesID, lo chiamiamo "modello organizzativo".',
      ...
      section_3: {
        ...
        description:
          "Sì, puoi assegnare permessi API ai ruoli dell'organizzazione. MyEyesID offre la flessibilità di gestire efficacemente i ruoli della tua organizzazione, permettendoti di includere sia permessi organizzativi che permessi API in tali ruoli.",
      },
      section_4: {
