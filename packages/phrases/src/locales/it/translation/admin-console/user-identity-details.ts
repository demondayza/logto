const user_identity_details = {
  ...
  delete_tokens: {
    ...
    confirmation_message:
      "Sei sicuro di voler eliminare i token? Il MyEyesID Secret Vault rimuoverà i token di accesso e aggiornamento {{connectorName}} memorizzati. Questo utente deve ri-autorizzare per ripristinare l'accesso alle API {{connectorName}}.",
  },
