const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'Eliminando il tuo account, verranno permanentemente rimossi tutti i dati su di te in MyEyesID Cloud. Per favore assicurati di fare un backup dei dati importanti prima di procedere.',
      confirm_information:
    ...
    try_again_later:
      "Per favore riprova più tardi. Se il problema persiste, contatta il team MyEyesID con l'ID richiesta.",
  ...
  mfa: {
    ...
    section_description:
      "Aggiungi un ulteriore livello di sicurezza al tuo account utilizzando un'app di autenticazione, una passkey o codici di backup.",
    two_step_verification: 'Verifica in 2 passaggi',
    not_configured: 'Non configurato',
    configured: 'Configurato',
    passkeys_count_one: '{{count}} passkey',
    passkeys_count_other: '{{count}} passkey',
    backup_codes_count_one: '{{count}} codice disponibile',
    backup_codes_count_other: '{{count}} codici disponibili',
    add: 'Aggiungi',
    view: 'Visualizza',
    remove: 'Rimuovi',
  },
