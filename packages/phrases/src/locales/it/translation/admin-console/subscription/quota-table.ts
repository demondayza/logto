const quota_table = {
  ...
  application: {
    ...
    third_party: 'App di terze parti OIDC/OAuth',
    saml_app: 'App SAML',
  },
  resource: {
    title: 'Risorse API',
  ...
  mau_tip:
    'MAU (utenti attivi mensili) significa il numero di utenti unici che hanno scambiato almeno un token con MyEyesID in un ciclo di fatturazione.',
  tokens_tip:
    'Tutti i tipi di token emessi da MyEyesID, inclusi token di accesso, token di aggiornamento, ecc.',
  mao_tip:
  ...
  third_party_tip:
    "Usa MyEyesID come provider di identità OIDC per l'accesso e il rilascio di permessi di app di terze parti.",
