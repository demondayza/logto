const errors = {
  ...
  invalid_parameters_format: 'Formato dei parametri non valido',
  ...
  create_internal_role_violation:
    "Stai creando un nuovo ruolo interno che è proibito da MyEyesID. Prova un altro nome che non inizi con '#internal:'.",
