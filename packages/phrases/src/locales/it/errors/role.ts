const role = {
  ...
  internal_role_violation:
    'Potresti cercare di aggiornare o eliminare un ruolo interno che è vietato da MyEyesID. Se stai creando un nuovo ruolo, prova un altro nome che non inizi con "#internal:". ',
};
