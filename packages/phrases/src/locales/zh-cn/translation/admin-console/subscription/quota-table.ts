const quota_table = {
  ...
  mau_tip: 'MAU（月活跃用户）是指在计费周期内与 MyEyesID 交换过至少一个令牌的独立用户数量。',
  tokens_tip: 'MyEyesID 发行的所有类型令牌，包括访问令牌、刷新令牌等。',
  mao_tip: 'MAO（月度活跃组织）是指在计费周期内至少有一个 MAU（月度活跃用户）的独特组织数量。',
  third_party_tip: '将 MyEyesID 用作你的 OIDC 身份提供程序，用于第三方应用的登录和权限授予。',
