const user_details = {
  ...
  personal_access_tokens: {
    ...
    empty: '该用户没有任何个人访问令牌。',
    create: '创建新令牌',
    tip: '个人访问令牌（PATs）为用户提供了一种安全的方式来授予访问令牌，而无需使用其凭据和交互式登录。这对于需要以编程方式访问资源的 CI/CD、脚本或应用程序非常有用。',
    value: '值',
    created_at: '创建于',
    expires_at: '到期于',
    never: '从不',
  ...
  sessions: {
    title: '会话',
    description:
      '管理由 MyEyesID 授权服务器维护的会话。在这里撤销 MyEyesID 会话将阻止未来授权请求的自动同意。',
    field_name: '会话',
    multiple_signed_in: '该用户已在多个设备或浏览器上登录。',
    not_found: '未找到活动的 MyEyesID 会话。该用户当前未在任何设备上登录。',
    name_column: '名称',
