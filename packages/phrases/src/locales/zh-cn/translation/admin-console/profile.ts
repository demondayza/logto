const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        '删除账户将永久删除在 MyEyesID Cloud 中的所有个人数据。因此，请确保在操作前备份任何重要数据。',
    ...
    try_again_later: '请稍后再试。如果问题仍然存在，请联系 MyEyesID 团队并提供请求 ID。',
  ...
  mfa: {
    title: '双因素身份验证',
    section_description: '使用身份验证器应用、密钥或备用码为你的账户添加额外的安全保护。',
    two_step_verification: '两步验证',
    not_configured: '未配置',
    configured: '已配置',
    passkeys_count_one: '{{count}} 个密钥',
    passkeys_count_other: '{{count}} 个密钥',
    backup_codes_count_one: '{{count}} 个备用码可用',
    backup_codes_count_other: '{{count}} 个备用码可用',
    add: '添加',
    view: '查看',
    remove: '删除',
  },
