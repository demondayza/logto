const protected_app = {
  ...
  form: {
    ...
    domain_field_tooltip:
      "Las aplicaciones protegidas por MyEyesID se alojarán en 'tu-dominio.{{dominio}}' de forma predeterminada. Se puede aplicar un dominio personalizado después de la creación.",
