const get_started = {
  ...
  subtitle: 'Algunas cosas que puedes hacer para obtener rápidamente el valor de MyEyesID',
  develop: {
  ...
  customize: {
    ...
    preview: {
      ...
      subtitle: 'Prueba la experiencia de inicio de sesión de MyEyesID ahora y ve cómo funciona',
    },
    connector: {
