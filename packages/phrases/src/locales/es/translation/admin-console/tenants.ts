const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      'Selecciona dónde se alojará tu inquilino. Elige MyEyesID Cloud para infraestructura compartida pública o una instancia privada para recursos dedicados.',
    ...
    enterprise_sso_description:
      'Disponible en planes de pago. Contáctenos para habilitar Enterprise SSO para que todos los miembros puedan iniciar sesión en MyEyesID Cloud Console usando el proveedor de identidad de su organización.',
  },
  full_env_tag: {
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'Personalice el ID del inquilino. Si se deja vacío, MyEyesID generará un ID predeterminado. El ID del inquilino no se puede cambiar después de la creación.',
  },
  ...
  tenant_landing_page: {
    ...
    description:
      'Para empezar a configurar tu proyecto con MyEyesID, por favor crea un nuevo inquilino. Si necesitas cerrar la sesión o eliminar tu cuenta, simplemente haz clic en el botón de avatar en la esquina superior derecha.',
