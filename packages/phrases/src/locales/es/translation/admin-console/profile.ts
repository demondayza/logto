const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'Eliminar tu cuenta eliminará permanentemente todos tus datos en MyEyesID Cloud. Así que asegura respaldar cualquier dato importante antes de proceder.',
      confirm_information:
    ...
    try_again_later:
      'Por favor, inténtalo nuevamente más tarde. Si el problema persiste, contacta al equipo de MyEyesID con el ID de solicitud.',
  ...
  mfa: {
    ...
    section_description:
      'Añade una capa adicional de seguridad a tu cuenta utilizando una aplicación de autenticación, una clave de acceso o códigos de respaldo.',
    two_step_verification: 'Verificación en 2 pasos',
    not_configured: 'No configurado',
    configured: 'Configurado',
    passkeys_count_one: '{{count}} clave de acceso',
    passkeys_count_other: '{{count}} claves de acceso',
    backup_codes_count_one: '{{count}} código disponible',
    backup_codes_count_other: '{{count}} códigos disponibles',
    add: 'Añadir',
    view: 'Ver',
    remove: 'Eliminar',
  },
