const enterprise_sso_details = {
  ...
  service_provider_property_description:
    'Configure una integración de aplicaciones utilizando {{protocol}} en su proveedor de identidad. Ingrese los detalles proporcionados por MyEyesID.',
  attribute_mapping_title: 'Mapeo de atributos',
  attribute_mapping_description:
    'Sincronice perfiles de usuario desde el proveedor de identidad configurando el mapeo de atributos de usuario en el proveedor de identidad o en MyEyesID.',
  saml_preview: {
  ...
  idp_initiated_auth_config: {
    ...
    redirect_uri_tooltip:
      'El URI de redirección para redirigir a los usuarios después de un inicio de sesión exitoso. MyEyesID usará este URI como el URI de redirección OIDC en la solicitud de autorización. Usa un URI dedicado para el flujo de autenticación SSO iniciado por el IdP para una mejor seguridad.',
  ...
  trust_unverified_email_tip:
    'El conector Entra ID (OIDC) no devuelve la reclamación `email_verified`, lo que significa que las direcciones de correo electrónico de Azure no están garantizadas como verificadas. Por defecto, MyEyesID no sincronizará direcciones de correo electrónico no verificadas con el perfil del usuario. Habilite esta opción solo si confía en todas las direcciones de correo electrónico del directorio Entra ID.',
  trust_unverified_email_tip_oidc:
    'El conector OIDC puede no devolver la reclamación `email_verified`, lo que significa que las direcciones de correo electrónico del IdP no están garantizadas como verificadas. Por defecto, MyEyesID no sincronizará direcciones de correo electrónico no verificadas con el perfil del usuario. Habilite esta opción solo si confía en todas las direcciones de correo electrónico del IdP.',
  offline_access: {
