const organizations = {
  ...
  guide: {
    ...
    introduction: {
      title: 'Comprenda cómo funciona la organización en MyEyesID',
      section_1: {
      ...
      section_2: {
        ...
        description:
          'En aplicaciones SaaS multiinquilino, varias organizaciones a menudo comparten la misma plantilla de control de acceso, que incluye permisos y roles. En MyEyesID, lo llamamos "plantilla de organización".',
      ...
      section_3: {
        ...
        description:
          'Sí, puedes asignar permisos de API a roles de organización. MyEyesID ofrece la flexibilidad para gestionar los roles de tu organización de manera efectiva, permitiéndote incluir tanto permisos de organización como permisos de API dentro de esos roles.',
      },
      section_4: {
