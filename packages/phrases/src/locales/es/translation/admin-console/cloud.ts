const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Un inquilino es un entorno aislado donde puedes gestionar identidades de usuarios, aplicaciones y todos los demás recursos de MyEyesID.',
    invite_collaborators: 'Invita a tus colaboradores por correo electrónico',
  },
  social_callback: {
    title: 'Ha iniciado sesión correctamente',
    description:
      'Ha iniciado sesión correctamente utilizando su cuenta social. Para garantizar una integración perfecta y el acceso a todas las funciones de MyEyesID, recomendamos que proceda a configurar su propio conector social.',
    notice:
