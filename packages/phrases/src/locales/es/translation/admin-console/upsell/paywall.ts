const paywall = {
  ...
  saml_applications_oss:
    'La aplicación SAML adicional está disponible con el plan MyEyesID Enterprise. Contáctanos si necesitas asistencia.',
  myeyesid_pricing_button_text: 'Precios de MyEyesID Cloud',
  saml_applications:
    'La aplicación SAML adicional está disponible con el plan MyEyesID Enterprise. Contáctanos si necesitas asistencia.',
  ...
  third_party_apps:
    'Desbloquea MyEyesID como proveedor de identidades para aplicaciones de terceros al actualizar a un plan de pago. Para cualquier asistencia, no dudes en <a>contactarnos</a>.',
  sso_connectors:
  ...
  branding_customization:
    'Desbloquea el control total de la marca con las funciones "Ocultar la marca MyEyesID" y "Trae tu interfaz de usuario" al actualizar tu plan.',
  bring_your_ui:
