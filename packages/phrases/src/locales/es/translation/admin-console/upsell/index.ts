...
const upsell = {
  ...
  create_tenant: {
    ...
    description:
      'MyEyesID ofrece opciones de planes competitivos con una innovadora y asequible estructura de precios diseñada para empresas en crecimiento. <a>Más información</a>',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      'Tu MAU actual ha superado el límite de <planName/>. Por favor, actualiza tu plan a premium a tiempo para evitar la suspensión del servicio de MyEyesID.',
    update_plan: 'Actualizar plan',
  },
  token_exceeded_modal: {
    title: 'Se ha superado el límite de uso de tokens. Actualiza tu plan.',
    notification:
      'Has excedido el límite de uso de tokens de <planName/>. Los usuarios no podrán acceder al servicio de MyEyesID correctamente. Por favor, actualiza tu plan a premium sin demora para evitar cualquier inconveniente.',
  },
  payment_overdue_modal: {
    title: 'Factura con pagos atrasados',
    notification:
      '¡Ups! El pago de la factura del inquilino <span>{{name}}</span> ha fallado. Por favor, pague la factura a tiempo para evitar la suspensión del servicio de MyEyesID.',
  ...
  charge_notification_for_quota_limit:
    'Has superado tu límite de cuota de {{item}}. MyEyesID agregará cargos por el uso más allá de tu límite de cuota. La facturación comenzará el día en que se lance el nuevo diseño de precios del complemento. <a>Más información</a>',
  paywall,
