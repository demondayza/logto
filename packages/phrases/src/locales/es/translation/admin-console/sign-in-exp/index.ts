...
const sign_in_exp = {
  ...
  branding: {
    ...
    hide_myeyesid_branding: 'Ocultar la marca MyEyesID',
  ...
  account_center: {
    ...
    enable_account_api_description:
      'Activa la Account API para crear un centro de cuentas personalizado y ofrecer a los usuarios finales acceso directo a la API sin utilizar la MyEyesID Management API.',
    field_options: {
      off: 'Desactivado',
      edit: 'Editar',
    ...
    prebuilt_ui: {
      ...
      flows_description:
        'Combina tu dominio con la ruta para formar tu URL de configuración de cuenta (por ejemplo, https://auth.foo.com/account/email). Opcionalmente, agrega un parámetro de URL `redirect=` para devolver a los usuarios a tu aplicación después de actualizar con éxito.',
      tooltips: {
