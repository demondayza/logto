const errors = {
  ...
  invalid_parameters_format: 'Formato de parámetros no válido',
  ...
  create_internal_role_violation:
    'Estás creando un nuevo rol interno que está prohibido por MyEyesID. Prueba con otro nombre que no comience con "#intern:".',
