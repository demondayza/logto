const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'Un MAU es un usuario único que ha intercambiado al menos un token con MyEyesID dentro de un ciclo de facturación. Ilimitado para el Plan Pro. <a>Más información</a>',
    tooltip_for_enterprise:
      'Un MAU es un usuario único que ha intercambiado al menos un token con MyEyesID dentro de un ciclo de facturación. Ilimitado para el Plan Empresarial.',
  },
  organizations: {
