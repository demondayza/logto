...
const subscription = {
  ...
  free_plan_description:
    'Para proyectos secundarios y pruebas iniciales de MyEyesID. No se requiere tarjeta de crédito.',
  pro_plan: 'Plan Pro',
  pro_plan_description: 'Benefíciese sin preocupaciones con MyEyesID para empresas.',
  ...
  payment_error:
    'Se ha detectado un problema de pago. No se puede procesar ${ {price, number}} para el ciclo anterior. Actualice el pago para evitar la suspensión del servicio MyEyesID.',
  downgrade: 'Degradar',
  current: 'Actual',
  upgrade: 'Actualizar',
  quota_table,
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      'Actualmente estás usando más de lo permitido por <name />. MyEyesID es ahora oficial e incluye características adaptadas a cada plan. Antes de considerar la actualización al <name />, asegúrate de cumplir con los siguientes criterios antes de hacer el upgrade.',
  ...
  token_usage_notification: {
    exceeded:
      'Has excedido el 100% de tu límite de cuota. Los usuarios ya no podrán iniciar sesión correctamente. Por favor, actualiza inmediatamente para evitar inconvenientes.',
    close_to_limit:
      'Casi alcanzas tu límite de uso de tokens. MyEyesID dejará de otorgar tokens si tu uso excede el 100%. Por favor, actualiza el Plan Gratuito para evitar inconvenientes.',
    dev_plan_exceeded:
      'Este inquilino ha alcanzado el límite de tokens según la política de límite de entidad de MyEyesID.',
  },
};
