const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        '刪除賬戶將會永久刪除你在 MyEyesID Cloud 的所有數據。因此，請確保在繼續操作前備份所有重要數據。',
    ...
    try_again_later: '請稍後再試。如果問題仍然存在，請聯繫 MyEyesID 團隊並提供請求 ID。',
  ...
  mfa: {
    title: '雙重身份驗證',
    section_description: '使用身份驗證器應用程式、通行密鑰或備用碼為你的帳戶添加額外的安全保護。',
    two_step_verification: '兩步驟驗證',
    not_configured: '未配置',
    configured: '已配置',
    passkeys_count_one: '{{count}} 個通行密鑰',
    passkeys_count_other: '{{count}} 個通行密鑰',
    backup_codes_count_one: '{{count}} 個備用碼可用',
    backup_codes_count_other: '{{count}} 個備用碼可用',
    add: '新增',
    view: '查看',
    remove: '移除',
  },
