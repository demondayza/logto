const user_details = {
  ...
  personal_access_tokens: {
    ...
    create: '創建新令牌',
    tip: '個人訪問令牌（PATs）提供了一種安全方式，允許用戶在不使用憑據和互動登錄的情況下授予訪問權限。這對於 CI/CD、腳本或需要以程式方式訪問資源的應用程序很有用。',
    value: '值',
    created_at: '創建於',
    expires_at: '過期於',
    never: '永不過期',
  ...
  sessions: {
    title: '會話',
    description:
      '管理由 MyEyesID 授權服務器維護的會話。在此撤銷 MyEyesID 會話將阻止在未來授權請求時自動同意。',
    field_name: '會話',
    multiple_signed_in: '該用戶已登入多個設備或瀏覽器。',
    not_found: '未找到活動的 MyEyesID 會話。該用戶目前未在任何設備上登錄。',
    name_column: '名稱',
