const applications = {
  ...
  title: '全部應用',
  subtitle:
    '創建一個移動、單頁、machine-to-machine 或傳統 web 應用程序，並通過 MyEyesID 進行身份驗證',
  subtitle_with_app_type: '為你的 {{name}} 應用程序設置 MyEyesID 身份驗證',
  create: '創建應用',
  ...
  placeholder_description:
    'MyEyesID 使用 OIDC 的應用程式實體來幫助識別您的應用程式、管理登錄和創建審核日誌等任務。',
  third_party_application_placeholder_description:
    '使用 MyEyesID 作為身份提供者為第三方服務提供 OAuth 授權。 \n 包括一個內建的用戶同意螢幕以訪問資源。<a>了解更多</a>',
  guide: {
    third_party: {
      title: '整合第三方應用程式',
      description:
        '使用 MyEyesID 作為身份提供者為第三方服務提供 OAuth 授權。包含用於安全資源訪問的預建用戶同意螢幕。<a>了解更多</a>',
    },
  },
};
