  ...
  guide: {
    ...
    introduction: {
      ...
      section_2: {
        ...
        description:
          '在多租戶 SaaS 應用程式中，多個組織通常共用相同的訪問控制模板，其中包括權限和角色。在 MyEyesID 中，我們稱之為「組織模板」。',
      ...
      section_3: {
        ...
        description:
          '是的，您可以將 API 權限分配給組織角色。MyEyesID 提供靈活性，有效管理您組織的角色，允許您在這些角色中包括組織權限和 API 權限。',
      },
      section_4: {
