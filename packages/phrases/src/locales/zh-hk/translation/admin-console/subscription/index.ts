...
const subscription = {
  free_plan: '免費計劃',
  free_plan_description: '用於側建項目和 MyEyesID 初試。無需信用卡。',
  pro_plan: '專業計劃',
  pro_plan_description: '供企業放心使用 MyEyesID。',
  enterprise: '企業計劃',
  ...
  payment_error:
    '檢測到付款問題。無法處理前一個週期的 ${{price, number}}。更新付款以避免 MyEyesID 服務暫停。',
  downgrade: '降級',
  current: '當前',
  upgrade: '升級',
  quota_table,
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      '你幾乎達到了令牌使用限制。如果你的使用量超過 100%，MyEyesID 將停止發放令牌。請升級免費計劃以避免任何不便。',
    dev_plan_exceeded: '此租戶已達到 MyEyesID 的實體限制政策中的令牌限制。',
  },
};
