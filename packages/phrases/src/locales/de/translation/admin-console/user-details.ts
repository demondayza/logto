const user_details = {
  ...
  sessions: {
    title: 'Sitzungen',
    description:
      'Verwalte Sitzungen, die vom MyEyesID Authorization Server aufrechterhalten werden. Das Widerrufen einer MyEyesID-Sitzung hier verhindert die automatische Zustimmung bei zukünftigen Autorisierungsanfragen.',
    field_name: 'Sitzungen',
    multiple_signed_in: 'Dieser Benutzer hat sich an mehreren Geräten oder Browsern angemeldet.',
    not_found:
      'Keine aktiven MyEyesID-Sitzungen gefunden. Der Benutzer ist derzeit auf keinem Gerät angemeldet.',
    name_column: 'Name',
