const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'Ein MAU ist ein eindeutiger Nutzer, der innerhalb eines Abrechnungszyklus mindestens ein Token mit MyEyesID ausgetauscht hat. Unbegrenzt für den Pro-Plan. <a>Erfahre mehr</a>',
    tooltip_for_enterprise:
      'Ein MAU ist ein eindeutiger Nutzer, der innerhalb eines Abrechnungszyklus mindestens ein Token mit MyEyesID ausgetauscht hat. Unbegrenzt für den Enterprise-Plan.',
  },
  organizations: {
