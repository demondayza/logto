...
const subscription = {
  ...
  free_plan_description:
    'Für Nebenprojekte und erste MyEyesID-Tests. Keine Kreditkarte erforderlich.',
  pro_plan: 'Pro plan',
  pro_plan_description: 'Für Unternehmen, die sorgenfrei von MyEyesID profitieren möchten.',
  ...
  payment_error:
    'Es wurde ein Zahlungsproblem festgestellt. Der Betrag von ${{price, number}} für den vorherigen Zyklus kann nicht verarbeitet werden. Aktualisieren Sie die Zahlung, um eine Aussetzung des MyEyesID-Dienstes zu vermeiden.',
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      'Sie nutzen derzeit mehr als das, was <name /> erlaubt. MyEyesID ist nun offiziell und bietet Funktionen, die auf jeden Tarif zugeschnitten sind. Bevor Sie ein Upgrade auf den <name /> in Betracht ziehen, stellen Sie sicher, dass Sie die folgenden Kriterien für das Upgrade erfüllen.',
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      'Du hast fast dein Token-Nutzungslimit erreicht. MyEyesID wird keine Token mehr ausstellen, falls deine Nutzung 100 % überschreitet. Bitte upgrade den Gratis-Tarif, um Unannehmlichkeiten zu vermeiden.',
    dev_plan_exceeded:
      'Dieser Mandant hat das Token-Limit gemäß der Entitätsrichtlinie von MyEyesID erreicht.',
  },
};
