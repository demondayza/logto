...
const upsell = {
  ...
  create_tenant: {
    ...
    description:
      'MyEyesID bietet wettbewerbsfähige Planoptionen mit innovativer und erschwinglicher Preisgestaltung, die für wachsende Unternehmen entwickelt wurden. <a>Erfahren Sie mehr</a>',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      'Ihr aktueller MAU hat das Limit von <planName/> überschritten. Bitte upgraden Sie umgehend auf den Premium-Plan, um die Aussetzung des MyEyesID-Dienstes zu vermeiden.',
    update_plan: 'Plan aktualisieren',
  },
  token_exceeded_modal: {
    title: 'Token-Nutzung hat das Limit überschritten. Upgrade deinen Plan.',
    notification:
      'Du hast dein <planName/>-Token-Nutzungslimit überschritten. Benutzer werden nicht in der Lage sein, den MyEyesID-Dienst ordnungsgemäß zu nutzen. Bitte upgrade deinen Plan umgehend auf Premium, um Unannehmlichkeiten zu vermeiden.',
  },
  payment_overdue_modal: {
    title: 'Zahlungsrückstand für Rechnung',
    notification:
      'Hoppla! Die Zahlung für die Rechnung des Mieters <span>{{name}}</span> ist fehlgeschlagen. Bitte zahlen Sie die Rechnung umgehend, um eine Sperrung des MyEyesID-Dienstes zu vermeiden.',
  ...
  charge_notification_for_quota_limit:
    'Sie haben Ihr {{item}}-Quotenlimit überschritten. MyEyesID wird Gebühren für die Nutzung über Ihr Quotenlimit hinaus hinzufügen. Die Abrechnung beginnt am Tag der Veröffentlichung des neuen Add-On-Preisdesigns. <a>Mehr erfahren</a>',
  paywall,
