const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'Das Löschen deines Kontos wird alle Daten über dich in der MyEyesID Cloud dauerhaft entfernen. Bitte stelle sicher, dass du alle wichtigen Daten sicherst, bevor du fortfährst.',
      confirm_information:
    ...
    try_again_later:
      'Bitte versuche es später erneut. Wenn das Problem weiterhin besteht, kontaktiere bitte das MyEyesID-Team mit der Anfrage-ID.',
  ...
  mfa: {
    ...
    section_description:
      'Fügen Sie Ihrem Konto mit einer Authenticator-App, einem Passkey oder Backup-Codes eine zusätzliche Sicherheitsebene hinzu.',
    two_step_verification: '2-Schritt-Verifizierung',
    not_configured: 'Nicht konfiguriert',
    configured: 'Konfiguriert',
    passkeys_count_one: '{{count}} Passkey',
    passkeys_count_other: '{{count}} Passkeys',
    backup_codes_count_one: '{{count}} Code verfügbar',
    backup_codes_count_other: '{{count}} Codes verfügbar',
    add: 'Hinzufügen',
    view: 'Anzeigen',
    remove: 'Entfernen',
  },
