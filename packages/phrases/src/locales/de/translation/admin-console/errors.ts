const errors = {
  ...
  invalid_parameters_format: 'Ungültiges Parameterformat',
  ...
  create_internal_role_violation:
    'Sie erstellen eine neue interne Rolle, die von MyEyesID verboten ist. Versuchen Sie einen anderen Namen, der nicht mit "#internal:" beginnt.',
