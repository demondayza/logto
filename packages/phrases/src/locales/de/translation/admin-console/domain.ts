const domain = {
  ...
  update_endpoint_notice:
    'Vergessen Sie nicht, die Domain für die Social-Connector-Callback-URI und den MyEyesID-Endpunkt in Ihrer Anwendung zu aktualisieren, wenn Sie eine benutzerdefinierte Domain für die Funktionen verwenden möchten.',
  error_hint:
  ...
  custom: {
    ...
    deletion: {
      ...
      in_used_tip:
        'Wenn Sie diese benutzerdefinierte Domain bereits in Ihrem Social-Connector-Provider oder Anwendungs-Endpunkt eingerichtet haben, müssen Sie die URI zur MyEyesID-Standarddomain "<span>{{domain}}</span>" ändern. Dies ist notwendig, damit die Social-Sign-In-Schaltfläche ordnungsgemäß funktioniert.',
  ...
  default: {
    ...
    default_domain_description:
      'MyEyesID bietet eine vorkonfigurierte Standarddomain, die ohne zusätzliche Einrichtung verwendet werden kann. Diese Standarddomain dient als Backup-Option, auch wenn Sie eine benutzerdefinierte Domain aktiviert haben.',
    default_domain_field: 'MyEyesID Standard-Domain',
  },
