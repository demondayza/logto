const roles = {
  ...
  management_api_access_notification:
    'Für den Zugriff auf die MyEyesID-Verwaltungs-API wählen Sie Rollen mit Verwaltungs-API-Berechtigungen <flag/> aus.',
  with_management_api_access_tip:
    'Diese Maschinenrollen umfassen Berechtigungen für die MyEyesID-Verwaltungs-API',
