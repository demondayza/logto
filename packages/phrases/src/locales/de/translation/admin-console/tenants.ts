const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      'Wählen Sie, wo Ihr Mandant gehostet wird. Wählen Sie MyEyesID Cloud für eine öffentliche geteilte Infrastruktur oder eine private Instanz für dedizierte Ressourcen.',
    ...
    enterprise_sso_description:
      'Verfügbar in kostenpflichtigen Plänen. Kontaktieren Sie uns, um Enterprise SSO zu aktivieren, damit alle Mitglieder sich mit dem Identitätsanbieter Ihrer Organisation bei der MyEyesID Cloud Console anmelden können.',
  },
  full_env_tag: {
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'Passen Sie die Mandanten-ID an. Wenn leer gelassen, generiert MyEyesID eine Standard-ID. Die Mandanten-ID kann nach der Erstellung nicht geändert werden.',
  },
  ...
  tenant_landing_page: {
    ...
    description:
      'Um Ihr Projekt mit MyEyesID zu konfigurieren, erstellen Sie bitte einen neuen Mandanten. Wenn Sie sich abmelden oder Ihr Konto löschen möchten, klicken Sie einfach auf die Avatar-Taste in der oberen rechten Ecke.',
