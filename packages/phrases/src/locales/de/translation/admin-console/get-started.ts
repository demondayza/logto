const get_started = {
  ...
  subtitle: 'Einige Dinge, die Sie tun können, um schnell den Wert von MyEyesID zu erhalten',
  develop: {
  ...
  customize: {
    ...
    preview: {
      ...
      subtitle: 'Testen Sie jetzt das MyEyesID-Anmeldeerlebnis, um zu sehen, wie es funktioniert',
    },
    connector: {
      title:
