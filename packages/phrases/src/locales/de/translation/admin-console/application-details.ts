const application_details = {
  ...
  settings_description:
    'Eine Anwendung ist eine registrierte Software oder ein Dienst, der auf Benutzerinformationen zugreifen oder im Namen eines Nutzers agieren kann. Anwendungen helfen MyEyesID dabei, zu erkennen, wer was anfordert, und kümmern sich um Anmeldung und Berechtigungen. Füllen Sie die erforderlichen Felder für die Authentifizierung aus.',
  integration: 'Integration',
  integration_description:
    'Implementieren Sie sichere Worker von MyEyesID, die von Cloudflares Edge-Netzwerk betrieben werden, für eine erstklassige Leistung und weltweite 0ms-Cold-Starts.',
  ...
  always_issue_refresh_token_label:
    'Durch Aktivierung dieser Konfiguration kann MyEyesID immer Auffrischungstoken ausgeben, unabhängig davon, ob "prompt=consent" in der Authentifizierungsanforderung angegeben ist. Diese Praxis wird jedoch nur empfohlen, wenn es notwendig ist, da sie nicht mit OpenID Connect kompatibel ist und möglicherweise Probleme verursachen kann.',
  ...
  rotate_refresh_token_label:
    'Wenn diese Option aktiviert ist, wird MyEyesID ein neues Auffrischungstoken für Tokenanfragen ausgeben, wenn 70% der ursprünglichen Zeit bis zum Ablauf (TTL) verstrichen sind oder bestimmte Bedingungen erfüllt sind. <a>Erfahren Sie mehr</a>',
  rotate_refresh_token_label_for_public_clients:
    'Wenn aktiviert, wird MyEyesID für jede Tokenanfrage ein neues Auffrischungstoken ausstellen. <a>Erfahren Sie mehr</a>',
  ...
  app_domain_description_1:
    'Nutzen Sie Ihre Domain mit {{domain}} von MyEyesID, die dauerhaft gültig ist.',
  ...
  third_party_settings_description:
    'Integrieren Sie Drittanwendungen mit MyEyesID als Ihren Identity Provider (IdP) unter Verwendung von OIDC / OAuth 2.0, mit einem Einwilligungsbildschirm für die Benutzerautorisierung.',
  ...
  permissions: {
    ...
    permission_description_tips:
      'Wenn MyEyesID als Identitätsanbieter (IdP) für die Authentifizierung in Drittanbieter-Apps verwendet wird und Benutzer um Autorisierung gebeten werden, erscheint diese Beschreibung auf dem Einwilligungsbildschirm.',
    user_title: 'Benutzer',
    user_description:
  ...
  saml_idp_name_id_format: {
    ...
    persistent_description: 'Verwende MyEyesID-Benutzer-ID als Name ID',
    transient: 'Transient',
    transient_description: 'Verwende einmalige Benutzer-ID als Name ID',
    unspecified: 'Nicht spezifiziert',
    unspecified_description: 'Verwende MyEyesID-Benutzer-ID als Name ID',
