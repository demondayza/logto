const enterprise_subscription = {
  ...
  subscription: {
    ...
    add_on_description:
      'Dies sind zusätzliche Add-ons nach Bedarf basierend auf Ihrem Vertrag oder den standardmäßigen Pay-as-you-go-Sätzen von MyEyesID. Ihnen werden Gebühren entsprechend Ihrer tatsächlichen Nutzung berechnet.',
    included: 'Inklusive',
