const webhook_details = {
  ...
  settings: {
    ...
    events: 'Ereignisse',
    events_description:
      'Wählen Sie die Auslöserereignisse aus, die MyEyesID die POST-Anforderung senden wird.',
    name: 'Name',
    endpoint_url: 'Endpunkt-URL',
    signing_key: 'Signing Key',
    signing_key_tip:
      'Fügen Sie den von MyEyesID bereitgestellten geheimen Schlüssel als Anforderungsheader zu Ihrem Endpunkt hinzu, um die Echtheit der Nutzlast des Webhooks sicherzustellen.',
