const api_resource_details = {
  ...
  management_api_settings_description:
    'Die MyEyesID Management-API ist eine umfassende Sammlung von APIs, die Administratoren befähigen, eine Vielzahl von Aufgaben im Zusammenhang mit Identitäten zu verwalten, Sicherheitsrichtlinien durchzusetzen und Vorschriften und Standards einzuhalten.',
  management_api_notice:
    'Diese API repräsentiert die MyEyesID-Entität und kann nicht geändert oder gelöscht werden. Erstellen Sie eine Maschine-zu-Maschine-App, um die MyEyesID-Management-API aufzurufen. <a>Erfahren Sie mehr</a>',
