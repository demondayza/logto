const organizations = {
  ...
  guide: {
    ...
    introduction: {
      title: 'Verstehen Sie, wie eine Organisation in MyEyesID funktioniert',
      section_1: {
      ...
      section_2: {
        ...
        description:
          'In Multi-Tenant-SaaS-Anwendungen teilen häufig mehrere Organisationen dieselbe Zugriffskontrollvorlage, zu der Berechtigungen und Rollen gehören. In MyEyesID nennen wir es "Organisationsvorlage".',
      ...
      section_3: {
        ...
        description:
          'Ja, Sie können API-Berechtigungen zu Organisationsrollen zuweisen. MyEyesID bietet die Flexibilität, die Rollen Ihrer Organisation effektiv zu verwalten, und ermöglicht es Ihnen, sowohl Organisationsberechtigungen als auch API-Berechtigungen in diese Rollen einzuschließen.',
      },
      section_4: {
