const user_identity_details = {
  ...
  delete_tokens: {
    ...
    confirmation_message:
      'Sind Sie sicher, dass Sie die Token löschen möchten? MyEyesID Secret Vault entfernt die gespeicherten {{connectorName}} Zugriffs- und Aktualisierungstoken. Dieser Benutzer muss die {{connectorName}} API-Zugriffsrechte erneut autorisieren.',
  },
