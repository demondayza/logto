const roles = {
  ...
  management_api_access_notification:
    'สำหรับการเข้าถึง MyEyesID Management API ให้เลือกบทบาทที่มีสิทธิ์ Management API <flag/>',
  with_management_api_access_tip: 'บทบาทเครื่องกับเครื่องนี้มีสิทธิ์ MyEyesID Management API',
