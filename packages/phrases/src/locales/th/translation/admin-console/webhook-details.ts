const webhook_details = {
  ...
  settings: {
    ...
    events: 'เหตุการณ์',
    events_description: 'เลือกเหตุการณ์ที่เป็นตัวกระตุ้นที่ MyEyesID จะส่งคำขอ POST ไปยังคุณ',
    name: 'ชื่อ',
    endpoint_url: 'Endpoint URL',
    signing_key: 'Signing key',
    signing_key_tip:
      'เพิ่มคีย์ลับที่ MyEyesID มอบให้ลงใน endpoint ของคุณในรูปแบบ request header เพื่อยืนยันความถูกต้องของ payload ของ webhook',
