const application_details = {
  ...
  settings_description:
    '“แอปพลิเคชัน” คือซอฟต์แวร์หรือบริการที่ลงทะเบียนไว้ซึ่งสามารถเข้าถึงข้อมูลผู้ใช้หรือดำเนินการแทนผู้ใช้ได้ แอปพลิเคชันช่วยให้สามารถระบุได้ว่าใครกำลังขอข้อมูลอะไรจาก MyEyesID และจัดการการลงชื่อเข้าใช้และการให้สิทธิ์ กรุณากรอกฟิลด์ที่จำเป็นสำหรับการตรวจสอบตัวตน',
  integration: 'การผสานรวม',
  integration_description:
    "ปรับใช้ด้วย MyEyesID secure workers ที่ขับเคลื่อนโดย Cloudflare's edge network เพื่อประสิทธิภาพระดับสูงและเริ่มต้นแบบไม่หน่วงทั่วโลก",
  ...
  always_issue_refresh_token_label:
    'เมื่อเปิดใช้งาน MyEyesID จะออก refresh token เสมอ ไม่ว่าจะใช้ `prompt=consent` ในคำขอการตรวจสอบตัวตนหรือไม่ อย่างไรก็ตาม ไม่แนะนำเว้นแต่จำเป็น เนื่องจากไม่เข้ากันกับ OpenID Connect และอาจก่อให้เกิดปัญหา',
  ...
  rotate_refresh_token_label:
    'เมื่อเปิดใช้งาน MyEyesID จะออก refresh token ใหม่เมื่อขอ token เมื่อผ่านไป 70% ของ TTL ดั้งเดิมหรือเมื่อเข้าเงื่อนไขที่กำหนด <a>เรียนรู้เพิ่มเติม</a>',
  rotate_refresh_token_label_for_public_clients:
    'เมื่อเปิดใช้งาน MyEyesID จะออก refresh token ใหม่สำหรับการขอ token แต่ละครั้ง <a>เรียนรู้เพิ่มเติม</a>',
  ...
  app_domain_description_1:
    'คุณสามารถใช้โดเมนของคุณกับ {{domain}} ที่ขับเคลื่อนโดย MyEyesID ได้โดยไม่มีวันหมดอายุ',
  ...
  third_party_settings_description:
    'ผสานแอปพลิเคชันบุคคลที่สามกับ MyEyesID ในฐานะผู้ให้บริการตัวตน (IdP) โดยใช้ OIDC / OAuth 2.0 พร้อมหน้าจอยินยอมสำหรับการอนุญาตผู้ใช้',
  ...
  permissions: {
    ...
    permission_description_tips:
      'เมื่อใช้ MyEyesID เป็นผู้ให้บริการตัวตน (IdP) กับแอปบุคคลที่สามและขออนุญาตผู้ใช้ คำอธิบายนี้จะแสดงบนหน้าจอยินยอม',
    user_title: 'ผู้ใช้',
  ...
  saml_idp_name_id_format: {
    ...
    persistent_description: 'ใช้รหัสผู้ใช้ MyEyesID เป็น Name ID',
    transient: 'ชั่วคราว (Transient)',
    transient_description: 'ใช้รหัสผู้ใช้ครั้งเดียวเป็น Name ID',
    unspecified: 'ไม่ระบุ',
    unspecified_description: 'ใช้รหัสผู้ใช้ MyEyesID เป็น Name ID',
    email_address: 'อีเมล',
