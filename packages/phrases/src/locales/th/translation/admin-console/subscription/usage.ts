const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'MAU หมายถึงผู้ใช้ที่ไม่ซ้ำกันซึ่งได้แลกเปลี่ยนโทเคนอย่างน้อยหนึ่งครั้งกับ MyEyesID ในรอบบิล ไม่จำกัดสำหรับแผน Pro <a>เรียนรู้เพิ่มเติม</a>',
    tooltip_for_enterprise:
      'MAU หมายถึงผู้ใช้ที่ไม่ซ้ำกันซึ่งได้แลกเปลี่ยนโทเคนอย่างน้อยหนึ่งครั้งกับ MyEyesID ในรอบบิล ไม่จำกัดสำหรับแผน Enterprise',
  },
  organizations: {
    title: 'องค์กร',
    tooltip:
  ...
  tenant_members: {
    ...
    tooltip_one:
      'ฟีเจอร์เสริมคิดราคา ${{price, number}} ต่อสมาชิกต่อเดือน สมาชิกผู้เช่าคนแรก {{count}} ฟรี',
    tooltip_other:
      'ฟีเจอร์เสริมคิดราคา ${{price, number}} ต่อสมาชิกต่อเดือน สมาชิกผู้เช่าคนแรก {{count}} คนฟรี',
    tooltip_for_enterprise:
