const paywall = {
  ...
  scopes_per_resource_other:
    '{{count, number}} สิทธิ์ต่อ API resource ของ <planName/> ถึงขีดจำกัดแล้ว อัปเกรดเพื่อเพิ่มขนาด <a>ติดต่อเรา</a> หากต้องการความช่วยเหลือ',
  custom_domain:
    'ถึงขีดจำกัด {{count, number}} โดเมนที่กำหนดเองของ <planName/> แล้ว อัปเกรดเป็นแผนชำระเงินเพื่อเพิ่มโดเมนที่กำหนดเองหลายรายการและสิทธิประโยชน์พรีเมียม หากมีคำถาม โปรด <a>ติดต่อเรา</a>',
  ...
  saml_applications_oss:
    'สามารถใช้งาน SAML app เพิ่มเติมได้เมื่อใช้ MyEyesID Enterprise หากต้องการความช่วยเหลือ กรุณาติดต่อเรา',
  myeyesid_pricing_button_text: 'MyEyesID Cloud ราคา',
  saml_applications:
    'สามารถใช้งาน SAML app เพิ่มเติมได้เมื่อใช้ MyEyesID Enterprise หากต้องการความช่วยเหลือ กรุณาติดต่อเรา',
  ...
  third_party_apps:
    'ปลดล็อก MyEyesID สำหรับ third-party apps โดยการอัปเกรดเป็นแผนชำระเงิน หากต้องการความช่วยเหลือ โปรด <a>ติดต่อเรา</a>',
  sso_connectors:
  ...
  branding_customization:
    'อัปเกรดแผนของคุณเพื่อปลดล็อกการควบคุมแบรนด์แบบครบถ้วนด้วยฟีเจอร์ "ซ่อนแบรนด์ MyEyesID" และ "นำ UI ของคุณมาเอง"',
  bring_your_ui:
  ...
  passkey_sign_in:
    'อัปเกรดเป็นแผนแบบชำระเงินเพื่อใช้งานการลงชื่อเข้าใช้ด้วย Passkey และสิทธิประโยชน์ระดับพรีเมียม หากมีคำถาม โปรดอย่าลังเลที่จะ <a>ติดต่อเรา</a>',
};
