const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'การลบบัญชีจะลบข้อมูลทั้งหมดของคุณใน MyEyesID Cloud แบบถาวร กรุณาสำรองข้อมูลสำคัญก่อนดำเนินการ',
      confirm_information:
    ...
    try_again_later:
      'กรุณาลองใหม่อีกครั้งในภายหลัง หากปัญหายังคงอยู่ กรุณาติดต่อทีม MyEyesID พร้อมรหัสคำขอ',
  ...
  mfa: {
    title: 'การยืนยันตัวตนสองปัจจัย',
    section_description:
      'เพิ่มชั้นความปลอดภัยให้กับบัญชีของคุณโดยใช้แอปยืนยันตัวตน พาสคีย์ หรือรหัสสำรอง',
    two_step_verification: 'การยืนยัน 2 ขั้นตอน',
    not_configured: 'ยังไม่ได้ตั้งค่า',
    configured: 'ตั้งค่าแล้ว',
    passkeys_count_one: '{{count}} พาสคีย์',
    passkeys_count_other: '{{count}} พาสคีย์',
    backup_codes_count_one: '{{count}} รหัสพร้อมใช้งาน',
    backup_codes_count_other: '{{count}} รหัสพร้อมใช้งาน',
    add: 'เพิ่ม',
    view: 'ดู',
    remove: 'ลบ',
  },
