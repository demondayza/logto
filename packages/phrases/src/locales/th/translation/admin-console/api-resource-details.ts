const api_resource_details = {
  ...
  management_api_settings_description:
    'MyEyesID Management API คือชุด API ที่ครอบคลุม ช่วยให้งานบริหารจัดการตัวตน การบังคับใช้นโยบายความปลอดภัย และการปฏิบัติตามกฎระเบียบต่าง ๆ สำหรับผู้ดูแลระบบเป็นไปได้อย่างครบถ้วน',
  management_api_notice:
    'API นี้แทน MyEyesID entity และไม่สามารถแก้ไขหรือถูกลบได้ สร้างแอป machine-to-machine เพื่อเรียกใช้ MyEyesID Management API <a>เรียนรู้เพิ่มเติม</a>',
