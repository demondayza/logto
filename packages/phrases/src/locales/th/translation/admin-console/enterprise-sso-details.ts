const enterprise_sso_details = {
  ...
  service_provider_property_description:
    'ตั้งค่า Integration สำหรับแอปโดยใช้ {{protocol}} บน Identity Provider ของคุณ และกรอกรายละเอียดที่ได้จาก MyEyesID',
  attribute_mapping_title: 'การจับคู่ Attributes',
  attribute_mapping_description:
    'ซิงค์โปรไฟล์ผู้ใช้จาก Identity Provider โดยตั้งค่าการจับคู่ attribute ผู้ใช้ไม่ว่าจะทางฝั่ง Identity Provider หรือ MyEyesID',
  saml_preview: {
  ...
  idp_initiated_auth_config: {
    ...
    redirect_uri_tooltip:
      'Redirect URI สำหรับเปลี่ยนเส้นทางผู้ใช้หลังเข้าสู่ระบบ MyEyesID จะใช้ URI นี้เป็น OIDC redirect URI ในคำขอ authorization แนะนำให้ใช้ URI พิเศษสำหรับ SSO ที่เริ่มโดย IdP เพื่อความปลอดภัย',
  ...
  trust_unverified_email_tip:
    'ตัวเชื่อมต่อ Entra ID (OIDC) ไม่ได้ส่ง claim `email_verified` หมายความว่าอีเมลที่ได้จาก Azure อาจยังไม่ได้รับการยืนยัน โดยปกติแล้ว MyEyesID จะไม่ซิงค์อีเมลที่ยังไม่ได้รับการยืนยันไปยังโปรไฟล์ผู้ใช้ เปิดใช้งานตัวเลือกนี้หากคุณเชื่อถืออีเมลทั้งหมดจากไดเรกทอรี Entra ID',
  trust_unverified_email_tip_oidc:
    'ตัวเชื่อมต่อ OIDC อาจไม่ส่งคลেম `email_verified` ซึ่งหมายความว่าอีเมลจาก IdP ไม่ได้มีการยืนยันเสมอไป โดยปกติ MyEyesID จะไม่ซิงค์อีเมลที่ยังไม่ได้ยืนยันไปยังโปรไฟล์ผู้ใช้ เปิดใช้งานตัวเลือกนี้เฉพาะเมื่อคุณเชื่อถืออีเมลทั้งหมดจาก IdP เท่านั้น',
  offline_access: {
