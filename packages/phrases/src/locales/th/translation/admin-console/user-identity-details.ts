const user_identity_details = {
  ...
  delete_tokens: {
    ...
    confirmation_message:
      'คุณแน่ใจหรือไม่ว่าต้องการลบโทเค็น? MyEyesID Secret Vault จะลบโทเค็น access และ refresh ของ {{connectorName}} ที่จัดเก็บไว้ ผู้ใช้นี้ต้องอนุญาตใหม่เพื่อเข้าถึง API ของ {{connectorName}} อีกครั้ง',
  },
