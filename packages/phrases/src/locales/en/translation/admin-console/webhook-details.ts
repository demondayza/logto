const webhook_details = {
  ...
  settings: {
    ...
    events: 'Events',
    events_description: 'Select the trigger events which MyEyesID will send the POST request.',
    name: 'Name',
    endpoint_url: 'Endpoint URL',
    signing_key: 'Signing key',
    signing_key_tip:
      'Add the secret key provided by MyEyesID to your endpoint as a request header to ensure the authenticity of the webhook’s payload.',
