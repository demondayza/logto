const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'Deleting your account will permanently remove all data about you in MyEyesID Cloud. So please make sure to backup any important data before proceeding.',
      confirm_information:
    ...
    try_again_later:
      'Please try again later. If the problem persists, please contact MyEyesID team with the request ID.',
  ...
  mfa: {
    ...
    passkeys_count_one: '{{count}} passkey configured',
    passkeys_count_other: '{{count}} passkeys configured',
    backup_codes_count_one: '{{count}} code available',
    backup_codes_count_other: '{{count}} codes available',
    add: 'Add',
    view: 'View',
    remove: 'Remove',
  },
