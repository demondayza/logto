const enterprise_sso = {
  ...
  placeholder_description:
    'MyEyesID has provided many built-in enterprise identity providers to connect, meantime you can create your own with SAML and OIDC protocols.',
  create_modal: {
  ...
  attribute_mapping: {
    ...
    col_sp_claims: 'Value of service provider (MyEyesID)',
