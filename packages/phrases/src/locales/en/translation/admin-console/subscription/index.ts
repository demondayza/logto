...
const subscription = {
  free_plan: 'Free plan',
  free_plan_description: 'For side projects and initial MyEyesID trials. No credit card.',
  pro_plan: 'Pro plan',
  pro_plan_description: 'For businesses benefit worry-free with MyEyesID.',
  ...
  payment_error:
    'Payment issue detected. Unable to process ${{price, number}} for previous cycle. Update payment to avoid MyEyesID service suspension.',
  downgrade: 'Downgrade',
  current: 'Current',
  upgrade: 'Upgrade',
  quota_table,
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      'You’re currently using more than what the <name /> allows. MyEyesID is now official, including features tailored to each plan. Before you consider upgrading to the <name />, make sure you meet the following criteria before upgrading.',
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      'You almost reached your token usage limit. MyEyesID will stop granting token if your usage exceeds 100%. Please upgrade Free plan to avoid any inconvenience.',
    dev_plan_exceeded:
      "This tenant has reached the token limit per MyEyesID's entity limit policy.",
  },
};
