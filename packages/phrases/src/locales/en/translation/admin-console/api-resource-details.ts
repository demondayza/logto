const api_resource_details = {
  ...
  management_api_settings_description:
    'The MyEyesID Management API is a comprehensive collection of APIs that empower administrators to manage a wide range of identity-related tasks, enforce security policies, and comply with regulations and standards.',
  management_api_notice:
    'This API represents MyEyesID entity and cannot be modified or deleted. Create a machine-to-machine app to call MyEyesID Management API. <a>Learn more</a>',
