const user_identity_details = {
  ...
  delete_tokens: {
    ...
    confirmation_message:
      'Are you sure you want to delete tokens?  MyEyesID Secret Vault will remove the stored {{connectorName}} access and refresh tokens. This user must re-authorize to restore {{connectorName}} API access.',
  },
