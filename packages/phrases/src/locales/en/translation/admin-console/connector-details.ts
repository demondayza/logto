const connector_details = {
  ...
  test_sender_description:
    'MyEyesID uses the "Generic" template for testing. You will receive a message if your connector is rightly configured.',
  ...
  logto_email: {
    ...
    total_email_sent_tip:
      'MyEyesID utilizes SendGrid for secure and stable built-in email. It’s completely free to use. <a>Learn more</a>',
    ...
    test_notes: 'MyEyesID uses the “Generic” template for testing.',
  },
  google_one_tap: {
