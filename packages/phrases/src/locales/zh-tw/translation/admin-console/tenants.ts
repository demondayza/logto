const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      '選擇租戶將托管的位置。選擇 MyEyesID Cloud 的公共共享基礎設施，或選擇專用實例以獲得專屬資源。',
    ...
    enterprise_sso_description:
      '僅限付費方案。聯繫我們啟用企業 SSO，讓所有成員可以使用您組織的身分提供者登入 MyEyesID Cloud 控制台。',
  },
  full_env_tag: {
    development: '開發',
    production: '產品',
  ...
  tenant_landing_page: {
    title: '您尚未建立租戶',
    description:
      '要開始使用 MyEyesID 配置您的項目，請創建一個新租戶。如果您需要登出或刪除您的帳戶，只需點擊右上角的頭像按鈕。',
