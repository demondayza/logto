const user_details = {
  ...
  personal_access_tokens: {
    ...
    empty: '該用戶沒有任何個人訪問令牌。',
    create: '創建新令牌',
    tip: '個人訪問令牌（PATs）為用戶提供了一種不使用其憑證和交互式登錄情況下授予訪問令牌的安全方式。這對於 CI/CD、腳本或需要以程式化方式訪問資源的應用程式非常有用。',
    value: '值',
    created_at: '創建於',
    expires_at: '過期於',
    never: '永不',
  ...
  sessions: {
    title: '會話',
    description:
      '管理由 MyEyesID 授權服務器維護的會話。撤銷 MyEyesID 會話將阻止未來授權請求的自動同意。',
    field_name: '會話',
    multiple_signed_in: '該用戶已在多個設備或瀏覽器上登入。',
    not_found: '未找到活動的 MyEyesID 會話。用戶當前未在任何設備上登入。',
    name_column: '名稱',
