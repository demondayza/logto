...
const upsell = {
  ...
  token_exceeded_modal: {
    ...
    notification:
      '您的<planName/>令牌使用已超過限制。用戶將無法正常訪問 MyEyesID 服務。請儘快升級您的計劃至高級，以避免任何不便。',
  },
  payment_overdue_modal: {
    title: '賬單逾期未付',
    notification:
      '糟糕！租戶<span>{{name}}</span>的賬單支付失敗。請儘快支付賬單，以避免 MyEyesID 服務的中止。',
    unpaid_bills: '未付賬單',
    update_payment: '更新支付',
  },
  add_on_quota_item: {
  ...
  charge_notification_for_quota_limit:
    '您已超出{{item}}額度限制。MyEyesID將為超出額度限制的使用添加費用。計費將從新的附加價格設計發布當天開始。 <a>了解更多</a>',
  paywall,
