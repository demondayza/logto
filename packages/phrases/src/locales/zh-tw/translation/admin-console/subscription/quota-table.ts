const quota_table = {
  ...
  support: {
    ...
    solution_engineer_support: '解決方案工程師支援',
    sla: 'SLA',
    dedicated_computing_resources: '專用計算資源',
  },
  compliance: {
    title: '合規',
    soc2_compliant: '符合 SOC2',
    soc2_report: 'SOC2 報告',
  ...
  mau_tip: 'MAU（每月活躍用戶）是指在計費週期內與 MyEyesID 交換過至少一個令牌的獨立用戶數量。',
  tokens_tip: 'MyEyesID 發行的所有類型令牌，包括訪問令牌、刷新令牌等。',
  mao_tip: 'MAO（月度活躍組織）指的是在計費週期內至少有一個 MAU（月度活躍用戶）的獨特組織數量。',
  third_party_tip:
    '使用 MyEyesID 作為你的 OIDC 身份提供程序，以便第三方應用程式進行登錄和權限授予。',
