const protected_app = {
  ...
  form: {
    ...
    domain_field_tooltip:
      "Les applications protégées par MyEyesID seront hébergées par défaut à 'votre-domaine.{{domain}}'. Un domaine personnalisé peut être appliqué après la création.",
