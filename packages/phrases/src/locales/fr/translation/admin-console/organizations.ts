const organizations = {
  ...
  guide: {
    ...
    introduction: {
      title: "Comprendre le fonctionnement de l'organisation dans MyEyesID",
      section_1: {
      ...
      section_2: {
        ...
        description:
          "Dans les applications multi-locataires SaaS, plusieurs organisations partagent souvent le même modèle de contrôle d'accès, comprenant des autorisations et des rôles. Chez MyEyesID, nous l'appelons \"modèle d'organisation\".",
      ...
      section_3: {
        ...
        description:
          "Oui, vous pouvez attribuer des permissions API aux rôles de l'organisation. MyEyesID offre la flexibilité de gérer efficacement les rôles de votre organisation, vous permettant d'inclure à la fois les permissions d'organisation et les permissions API au sein de ces rôles.",
      },
      section_4: {
