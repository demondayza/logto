const quota_table = {
  ...
  application: {
    ...
    third_party: 'Applications tierces OIDC/OAuth',
    saml_app: 'Applications SAML',
  },
  resource: {
  ...
  mau_tip:
    "MAU (utilisateurs actifs mensuels) signifie le nombre d'utilisateurs uniques qui ont échangé au moins un jeton avec MyEyesID au cours d'un cycle de facturation.",
  tokens_tip:
    "Tous types de jetons émis par MyEyesID, y compris les jetons d'accès, les jetons de rafraîchissement, etc.",
  mao_tip:
  ...
  third_party_tip:
    "Utilisez MyEyesID comme votre fournisseur d'identité OIDC pour les connexions et les autorisations des applications tierces.",
