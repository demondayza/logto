const application_details = {
  ...
  settings_description:
    "Une application est un logiciel ou un service enregistré pouvant accéder aux informations utilisateur ou agir pour un utilisateur. Les applications aident MyEyesID à identifier qui demande quoi et gèrent la connexion ainsi que les autorisations. Remplissez les champs obligatoires pour l'authentification.",
  integration: 'Intégration',
  integration_description:
    'Déployez avec les travailleurs sécurisés de MyEyesID, alimentés par le réseau Edge de Cloudflare pour des performances de premier plan et des démarrages à froid de 0ms dans le monde entier.',
  ...
  myeyesid_endpoint: 'Point de terminaison MyEyesID',
  application_id: "ID de l'application",
  application_id_tip:
    "L'identifiant d'application unique généralement généré par MyEyesID. Il signifie également <a>client_id</a> dans OpenID Connect.",
  ...
  rotate_refresh_token_label:
    "Lorsqu'elle est activée, MyEyesID émettra un nouveau Refresh Token pour les demandes de jeton lorsque 70% de la durée de vie (TTL) d'origine est écoulée ou que certaines conditions sont remplies. <a>En savoir plus</a>",
  rotate_refresh_token_label_for_public_clients:
    "Lorsqu'elle est activée, MyEyesID émettra un nouveau token de rafraîchissement pour chaque demande de token. <a>En savoir plus</a>",
  ...
  app_domain_description_1:
    "N'hésitez pas à utiliser votre domaine avec {{domain}} alimenté par MyEyesID, qui est valide en permanence.",
  ...
  third_party_settings_description:
    "Intégrez des applications tierces avec MyEyesID comme votre fournisseur d'identité (IdP) en utilisant OIDC / OAuth 2.0, avec un écran de consentement pour l'autorisation de l'utilisateur.",
  ...
  permissions: {
    ...
    permission_description_tips:
      "Lorsque MyEyesID est utilisé comme fournisseur d'identités (IdP) pour l'authentification dans des applications tierces, et que les utilisateurs doivent donner leur autorisation, cette description apparaît sur l'écran de consentement.",
  ...
  saml_idp_name_id_format: {
    ...
    persistent_description: "Utilisez l'ID utilisateur MyEyesID comme ID de nom",
    transient: 'Transitoire',
    transient_description: 'Utilisez un ID utilisateur unique comme ID de nom',
    unspecified: 'Non spécifié',
    unspecified_description: "Utilisez l'ID utilisateur MyEyesID comme ID de nom",
  ...
  saml_app_attribute_mapping: {
    ...
    description:
      "Ajoutez des mappages d'attributs pour synchroniser le profil utilisateur de MyEyesID vers votre application.",
    col_myeyesid_claims: 'Valeur de MyEyesID',
