const enterprise_sso_details = {
  ...
  service_provider_property_description:
    "Configurez une intégration d'application utilisant {{protocol}} dans votre fournisseur d'identité. Entrez les détails fournis par MyEyesID.",
  attribute_mapping_title: "Correspondances d'attributs",
  attribute_mapping_description:
    "Synchronisez les profils des utilisateurs à partir du fournisseur d'identité en configurant la correspondance des attributs d'utilisateur soit sur le fournisseur d'identité soit du côté de MyEyesID.",
  saml_preview: {
  ...
  idp_initiated_auth_config: {
    ...
    redirect_uri_tooltip:
      "L'URI de redirection pour rediriger les utilisateurs après une connexion réussie. MyEyesID utilisera cette URI comme URI de redirection OIDC dans la demande d'autorisation. Utilisez une URI dédiée pour le flux d'authentification SSO initié par IdP pour une meilleure sécurité.",
