const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      'Sélectionnez où votre locataire sera hébergé. Choisissez MyEyesID Cloud pour une infrastructure partagée publique, ou une instance privée pour des ressources dédiées.',
    ...
    enterprise_sso_description:
      "Disponible sur les plans payants. Contactez-nous pour activer Enterprise SSO afin que tous les membres puissent se connecter à la console MyEyesID Cloud en utilisant le fournisseur d'identité de votre organisation.",
  },
  full_env_tag: {
  ...
  create_modal: {
    ...
    tenant_id_tip:
      "Personnalisez l'identifiant du locataire. Si laissé vide, MyEyesID générera un identifiant par défaut. L'identifiant du locataire ne peut pas être modifié après la création.",
  },
  ...
  tenant_landing_page: {
    ...
    description:
      "Pour commencer à configurer votre projet avec MyEyesID, veuillez créer un nouveau locataire. Si vous devez vous déconnecter ou supprimer votre compte, cliquez simplement sur le bouton d'avatar dans le coin supérieur droit.",
