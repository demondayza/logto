const user_identity_details = {
  ...
  delete_tokens: {
    ...
    confirmation_message:
      "Êtes-vous sûr de vouloir supprimer les jetons ? Le Coffre Secret de MyEyesID supprimera les jetons d'accès et de rafraîchissement {{connectorName}} stockés. Cet utilisateur doit réautoriser pour restaurer l'accès aux API de {{connectorName}}.",
  },
