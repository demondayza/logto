const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Un locataire est un environnement isolé où vous pouvez gérer les identités des utilisateurs, les applications et toutes les autres ressources MyEyesID.',
    invite_collaborators: 'Invitez vos collaborateurs par e-mail',
  },
  social_callback: {
    title: 'Connexion réussie',
    description:
      'Vous vous êtes connecté avec succès en utilisant votre compte social. Pour assurer une intégration fluide et accéder à toutes les fonctionnalités de MyEyesID, nous vous recommandons de configurer votre propre connecteur social.',
    notice:
