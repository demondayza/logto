const enterprise_subscription = {
  ...
  subscription: {
    ...
    add_on_description:
      'Ce sont des modules complémentaires à la carte basés sur votre contrat ou sur les tarifs standards à la carte de MyEyesID. Vous serez facturé en fonction de votre utilisation réelle.',
    included: 'Inclus',
