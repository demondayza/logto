const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'La suppression de votre compte supprimera définitivement toutes les données vous concernant dans MyEyesID Cloud. Assurez-vous donc de sauvegarder toutes les données importantes avant de continuer.',
      confirm_information:
    ...
    try_again_later:
      "Veuillez réessayer plus tard. Si le problème persiste, veuillez contacter l'équipe MyEyesID avec l'ID de la demande.",
  ...
  mfa: {
    ...
    section_description:
      "Ajoutez une couche de sécurité supplémentaire à votre compte en utilisant une application d'authentification, une clé d'accès ou des codes de secours.",
    two_step_verification: 'Vérification en 2 étapes',
    not_configured: 'Non configuré',
    configured: 'Configuré',
    passkeys_count_one: "{{count}} clé d'accès",
    passkeys_count_other: "{{count}} clés d'accès",
    backup_codes_count_one: '{{count}} code disponible',
    backup_codes_count_other: '{{count}} codes disponibles',
    add: 'Ajouter',
    view: 'Voir',
    remove: 'Supprimer',
  },
