const user_details = {
  ...
  sessions: {
    title: 'Sessions',
    description:
      "Gérer les sessions maintenues par le MyEyesID Authorization Server. Révoquer une session MyEyesID ici empêche le consentement automatique lors de futures demandes d'autorisation.",
    field_name: 'Sessions',
    multiple_signed_in: "Cet utilisateur s'est connecté sur plusieurs appareils ou navigateurs.",
    not_found:
      "Aucune session MyEyesID active trouvée. L'utilisateur n'est actuellement connecté sur aucun appareil.",
    name_column: 'Nom',
