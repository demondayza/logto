const roles = {
  ...
  management_api_access_notification:
    "Pour accéder à l'API de gestion de MyEyesID, sélectionnez des rôles avec les autorisations de l'API de gestion <flag/>.",
  with_management_api_access_tip:
    "Ce rôle machine à machine inclut les autorisations de l'API de gestion de MyEyesID",
