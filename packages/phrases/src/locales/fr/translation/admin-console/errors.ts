const errors = {
  ...
  invalid_parameters_format: 'Format des paramètres invalide',
  ...
  create_internal_role_violation:
    'Vous créez un nouveau rôle interne qui est interdit par MyEyesID. Essayez un autre nom qui ne commence pas par "#internal:".',
