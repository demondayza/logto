const errors = {
  ...
  invalid_parameters_format: 'Nieprawidłowy format parametrów',
  ...
  create_internal_role_violation:
    'Tworzysz nową wewnętrzną rolę, co jest zabronione przez MyEyesID. Spróbuj użyć innego nazwy, która nie zaczyna się od "#internal:". ',
