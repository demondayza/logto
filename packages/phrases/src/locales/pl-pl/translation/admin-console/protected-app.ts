const protected_app = {
  ...
  form: {
    ...
    domain_field_tooltip:
      "Aplikacje chronione przez MyEyesID będą hostowane domyślnie pod adresem 'twoja-domena.{{domain}}'. Domena niestandardowa może zostać zastosowana po utworzeniu.",
