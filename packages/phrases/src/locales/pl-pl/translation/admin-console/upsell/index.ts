...
const upsell = {
  ...
  create_tenant: {
    ...
    description:
      'MyEyesID oferuje konkurencyjne opcje planów z innowacyjnym i przystępnym cenowo modelem dla rozwijających się firm. <a>Dowiedz się więcej</a>',
  ...
  mau_exceeded_modal: {
    ...
    notification:
      'Obecna liczba MAU przekroczyła limit planu <planName/>. Proszę natychmiast zaktualizować swój plan na wersję premium, aby uniknąć zawieszenia usługi MyEyesID.',
    update_plan: 'Zaktualizuj plan',
  },
  token_exceeded_modal: {
    title: 'Użycie tokena przekroczyło limit. Ulepsz swój plan.',
    notification:
      'Przekroczyłeś limit użycia tokena <planName/>. Użytkownicy nie będą mogli prawidłowo korzystać z usługi MyEyesID. Proszę niezwłocznie uaktualnić swój plan do wersji premium, aby uniknąć niedogodności.',
  },
  payment_overdue_modal: {
    title: 'Opłata za fakturę zaległa',
    notification:
      'Ups! Płatność za fakturę najemcy <span>{{name}}</span> nie powiodła się. Proszę zapłacić fakturę w odpowiednim terminie, aby uniknąć zawieszenia usługi MyEyesID.',
  ...
  charge_notification_for_quota_limit:
    'Przekroczyłeś limit kwoty {{item}}. MyEyesID doliczy opłaty za korzystanie poza limitem. Fakturowanie rozpocznie się w dniu wprowadzenia nowego projektu cenowego dodatku. <a>Dowiedz się więcej</a>',
  paywall,
