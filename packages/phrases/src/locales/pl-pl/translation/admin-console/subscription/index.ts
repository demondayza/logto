...
const subscription = {
  ...
  free_plan_description:
    'Dla projektów pobocznych i początkowych prób MyEyesID. Brak wymaganej karty kredytowej.',
  pro_plan: 'Plan Pro',
  pro_plan_description: 'Dla firm, ciesz się bezstresową obsługą MyEyesID.',
  ...
  payment_error:
    'Wykryto problem z płatnością. Nie można przetworzyć ${{price, number}} za poprzedni cykl. Zaktualizuj płatność, aby uniknąć zawieszenia usługi MyEyesID.',
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      'Obecnie używasz więcej niż to, co pozwala <name />. MyEyesID jest teraz oficjalne, z funkcjami dostosowanymi do każdego planu. Zanim rozważysz aktualizację do <name />, upewnij się, że spełniasz poniższe kryteria przed dokonaniem aktualizacji.',
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      'Prawie osiągnąłeś limit użycia tokenów. MyEyesID przestanie przyznawać tokeny, jeśli twoje użycie przekroczy 100%. Proszę dokonać aktualizacji Planu Darmowego, aby uniknąć niedogodności.',
    dev_plan_exceeded:
      'Ten najemca osiągnął limit tokenów zgodnie z polityką limitu jednostki MyEyesID.',
  },
};
