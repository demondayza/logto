const quota_table = {
  ...
  application: {
    ...
    third_party: 'Aplikacje firm trzecich OIDC/OAuth',
    saml_app: 'Aplikacje SAML',
  },
  resource: {
    title: 'Zasoby API',
  ...
  mau_tip:
    'MAU (aktywni użytkownicy miesięczni) oznacza liczbę unikalnych użytkowników, którzy wymienili co najmniej jeden token z MyEyesID w cyklu rozliczeniowym.',
  tokens_tip:
    'Wszystkie rodzaje tokenów wydanych przez MyEyesID, w tym tokeny dostępu, tokeny odświeżania, itp.',
  mao_tip:
  ...
  third_party_tip:
    'Używaj MyEyesID jako dostawcy tożsamości OIDC do logowania firm trzecich i udzielania zgód.',
