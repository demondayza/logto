const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      'Wybierz, gdzie będzie hostowany twój najemca. Wybierz MyEyesID Cloud dla publicznej, współdzielonej infrastruktury, lub prywatną instancję dla dedykowanych zasobów.',
    ...
    enterprise_sso_description:
      'Dostępne w płatnych planach. Skontaktuj się z nami, aby włączyć Enterprise SSO, dzięki czemu wszyscy członkowie będą mogli logować się do konsoli MyEyesID Cloud za pomocą dostawcy tożsamości Twojej organizacji.',
  },
  full_env_tag: {
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'Dostosuj identyfikator najemcy. Jeśli pozostawisz puste, MyEyesID wygeneruje domyślny identyfikator. Identyfikator najemcy nie może zostać zmieniony po utworzeniu.',
  },
  ...
  tenant_landing_page: {
    ...
    description:
      'Aby rozpocząć konfigurowanie projektu z MyEyesID, utwórz nowego najemcę. Jeśli musisz się wylogować lub usunąć swoje konto, wystarczy kliknąć przycisk awatara w prawym górnym rogu.',
