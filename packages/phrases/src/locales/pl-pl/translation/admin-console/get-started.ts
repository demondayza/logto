const get_started = {
  ...
  subtitle: 'Kilka rzeczy, które możesz zrobić, aby szybko uzyskać wartość MyEyesID',
  develop: {
    ...
    subtitle_cloud:
      'Lub poświęć 5 minut na integrację swojej aplikacji za pomocą naszych gotowych SDKów i samouczków.',
  },
  customize: {
    ...
    preview: {
      ...
      subtitle: 'Wypróbuj teraz MyEyesID, aby zobaczyć, jak działa',
    },
    connector: {
