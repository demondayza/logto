const organizations = {
  ...
  guide: {
    ...
    introduction: {
      title: 'Zrozum, jak działa organizacja w MyEyesID',
      section_1: {
      ...
      section_2: {
        ...
        description:
          'W wielomandantowych aplikacjach typu SaaS, wiele organizacji często dzieli ten sam szablon kontroli dostępu, który obejmuje uprawnienia i role. W MyEyesID nazywamy to "szablonem organizacji".',
      ...
      section_3: {
        ...
        description:
          'Tak, możesz przypisać uprawnienia API do ról organizacyjnych. MyEyesID oferuje elastyczność w skutecznym zarządzaniu rolami w organizacji, pozwalając na włączenie zarówno uprawnień organizacyjnych, jak i uprawnień API do tych ról.',
      },
      section_4: {
