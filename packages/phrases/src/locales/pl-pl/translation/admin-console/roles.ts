const roles = {
  ...
  management_api_access_notification:
    'Aby uzyskać dostęp do interfejsu API zarządzania MyEyesID, wybierz role z uprawnieniami do interfejsu API zarządzania <flag/>.',
  with_management_api_access_tip:
    'Ta rola maszyny do maszyny zawiera uprawnienia do interfejsu API zarządzania MyEyesID',
