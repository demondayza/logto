const cloud = {
  ...
  create_tenant: {
    ...
    description:
      'Najemca to odizolowane środowisko, w którym możesz zarządzać tożsamościami użytkowników, aplikacjami i wszystkimi innymi zasobami MyEyesID.',
    invite_collaborators: 'Zaproś swoich współpracowników za pomocą e-maila',
  },
  social_callback: {
    title: 'Zalogowałeś się pomyślnie',
    description:
      'Zalogowałeś się pomyślnie używając swojego konta społecznościowego. Aby zapewnić bezproblemową integrację i dostęp do wszystkich funkcji MyEyesID, zalecamy przejście do konfiguracji własnego konektora społecznościowego.',
    notice:
