const webhook_details = {
  ...
  settings: {
    ...
    events: 'Zdarzenia',
    events_description: 'Wybierz zdarzenia wywołujące, które MyEyesID wyśle żądanie POST.',
    name: 'Nazwa',
    endpoint_url: 'Adres URL końcowego',
    signing_key: 'Klucz podpisu',
    signing_key_tip:
      'Dodaj klucz sekretny dostarczony przez MyEyesID do swojego endpointu jako nagłówek żądania, aby zapewnić autentyczność ładunku webhooka.',
