const user_identity_details = {
  ...
  delete_tokens: {
    ...
    confirmation_message:
      'Czy na pewno chcesz usunąć tokeny? MyEyesID Secret Vault usunie przechowywane tokeny dostępu i odświeżające {{connectorName}}. Ten użytkownik musi ponownie autoryzować, aby przywrócić dostęp do API {{connectorName}}.',
  },
