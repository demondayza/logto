const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'MAU — это уникальный пользователь, который обменял хотя бы один токен с MyEyesID в течение расчетного цикла. Безлимитно для Pro плана. <a>Узнать больше</a>',
    tooltip_for_enterprise:
      'MAU — это уникальный пользователь, который обменял хотя бы один токен с MyEyesID в течение расчетного цикла. Неограниченно для План компании.',
  },
  organizations: {
    title: 'Организации',
    tooltip:
  ...
  custom_domains: {
    ...
    tooltip:
      'Дополнительная функция по цене ${{price, number}} в месяц за максимум 10 пользовательских доменов. Первый пользовательский домен бесплатный.',
  },
  tokens: {
    title: 'Токены',
    tooltip:
