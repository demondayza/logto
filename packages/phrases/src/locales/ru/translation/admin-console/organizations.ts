const organizations = {
  ...
  guide: {
    ...
    introduction: {
      title: 'Давайте разберем, как устроена организация в MyEyesID',
      section_1: {
      ...
      section_2: {
        ...
        description:
          'В мультиарендных SaaS-приложениях несколько организаций часто разделяют один и тот же шаблон контроля доступа, включая разрешения и роли. В MyEyesID мы называем это "шаблон организации".',
      ...
      section_3: {
        ...
        description:
          'Да, вы можете назначить разрешения API организационным ролям. MyEyesID предоставляет гибкость в управлении ролями вашей организации, позволяя включать в эти роли как организационные, так и разрешения API.',
      },
      section_4: {
