const get_started = {
  ...
  subtitle:
    'Несколько вещей, которые вы можете сделать, чтобы быстро получить ценность от MyEyesID',
  develop: {
  ...
  customize: {
    ...
    preview: {
      ...
      subtitle:
        'Попробуйте пробный вариант входа в систему MyEyesID, чтобы узнать, как это работает',
    },
    connector: {
      title:
