const protected_app = {
  ...
  form: {
    ...
    domain_field_tooltip:
      "Приложения, защищенные через MyEyesID, будут размещены по адресу 'your-domain.{{domain}}' по умолчанию. После создания может быть применен пользовательский домен.",
