const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        'Удаление вашего аккаунта навсегда удалит все данные о вас в MyEyesID Cloud. Пожалуйста, убедитесь, что у вас есть резервная копия всех важных данных перед продолжением.',
      confirm_information:
    ...
    try_again_later:
      'Пожалуйста, попробуйте позже. Если проблема сохраняется, пожалуйста, свяжитесь с командой MyEyesID с использованием Request ID.',
  ...
  mfa: {
    ...
    section_description:
      'Добавьте дополнительный уровень безопасности к вашему аккаунту, используя приложение-аутентификатор, ключ доступа или резервные коды.',
    two_step_verification: 'Двухэтапная проверка',
    not_configured: 'Не настроено',
    configured: 'Настроено',
    passkeys_count_one: '{{count}} ключ доступа',
    passkeys_count_other: '{{count}} ключей доступа',
    backup_codes_count_one: '{{count}} код доступен',
    backup_codes_count_other: '{{count}} кодов доступно',
    add: 'Добавить',
    view: 'Просмотр',
    remove: 'Удалить',
  },
