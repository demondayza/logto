...
const sign_in_exp = {
  ...
  color: {
    ...
    dark_mode_description:
      'Ваше приложение будет иметь автоматически созданную темную тему на основе цвета вашего бренда и алгоритма MyEyesID. Вы можете настроить ее по своему вкусу.',
  ...
  custom_ui: {
    ...
    bring_your_ui_description:
      'Загрузите сжатый пакет (.zip), чтобы заменить предустановленный интерфейс MyEyesID вашим собственным кодом. <a>Узнать больше</a>',
  ...
  account_center: {
    ...
    sections: {
      account_security: {
        ...
        description:
          'Управляйте доступом к Account API, чтобы пользователи после входа в приложение могли просматривать или изменять сведения о личности и факторы аутентификации.',
        security_verification: {
          title: 'Проверка безопасности',
          description:
            'Прежде чем изменять настройки безопасности, пользователи должны подтвердить свою личность и получить идентификатор записи проверки, действительный в течение 10 минут. Чтобы включить метод проверки (электронная почта, телефон, пароль), установите разрешение Account API ниже на <strong>Только чтение</strong> (минимум) или <strong>Редактировать</strong>, чтобы система могла определить, настроил ли пользователь его. <a>Подробнее</a>',
        },
        groups: {
          identifiers: {
    ...
    prebuilt_ui: {
      ...
      permission_notice:
        'Для интеграции этих готовых потоков установите соответствующие разрешения Account API на <strong>Редактирование</strong> в настройках ниже.',
