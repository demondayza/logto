const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      'Выберите, где будет размещен ваш арендатор. Выберите MyEyesID Cloud для общей публичной инфраструктуры или частный экземпляр для выделенных ресурсов.',
    ...
    development_description:
      'Только для тестирования и не должно использоваться в производстве. Подписка не требуется. Он имеет все профессиональные функции, но с ограничениями, такими как баннер входа.',
    production_description:
      'Предназначен для приложений, используемых конечными пользователями и может потребовать платную подписку.',
    ...
    enterprise_sso_description:
      'Доступно в платных планах. Свяжитесь с нами, чтобы включить Enterprise SSO, чтобы все участники могли входить в консоль MyEyesID Cloud, используя поставщика идентификации вашей организации.',
  },
  full_env_tag: {
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'Настройте идентификатор арендатора. Если оставить пустым, MyEyesID сгенерирует идентификатор по умолчанию. Идентификатор арендатора нельзя изменить после создания.',
  },
  ...
  tenant_landing_page: {
    ...
    description:
      'Чтобы начать настройку вашего проекта с помощью MyEyesID, создайте нового арендатора. Если вам нужно выйти из системы или удалить свою учетную запись, просто нажмите на кнопку аватара в правом верхнем углу.',
    create_tenant_button: 'Создать арендатора',
  },
  status: {
    mau_exceeded: 'Превышение MAU',
    token_exceeded: 'Превышение токена',
