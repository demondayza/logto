const application_details = {
  ...
  settings_description:
    '«Приложение» — это зарегистрированное программное обеспечение или сервис, которое может получать доступ к информации пользователя либо действовать от его имени. Приложения помогают узнавать, кто запрашивает какие данные у MyEyesID и обрабатывать вход и разрешения. Заполните необходимые поля для аутентификации.',
  integration: 'Интеграция',
  integration_description:
    'Развертывайте защищенные рабочие процессы MyEyesID, работающие на сети реберного узла Cloudflare, для обеспечения высочайшей производительности и нулевого времени запуска в любой точке мира.',
  ...
  always_issue_refresh_token_label:
    'Включение этой настройки позволит MyEyesID всегда выдавать Refresh Tokens, независимо от того, была ли в запросе на аутентификацию предложена команда `prompt=consent`. Однако данная практика не рекомендуется, если это необходимо, поскольку она несовместима с OpenID Connect и может вызвать проблемы.',
  ...
  rotate_refresh_token_label:
    'При включении MyEyesID будет выдавать новый Refresh Token для запросов токенов, когда пройдет 70% изначального Time to Live (TTL) или будут выполнены определенные условия. <a>Узнать больше</a>',
  rotate_refresh_token_label_for_public_clients:
    'При включении MyEyesID будет выдавать новый Refresh Token для каждого запроса токена. <a>Узнать больше</a>',
  ...
  app_domain_description_1:
    'Не стесняйтесь использовать ваш домен с {{domain}}, под управлением MyEyesID, который имеет постоянную действительность.',
  ...
  third_party_settings_description:
    'Интегрируйте сторонние приложения с MyEyesID в качестве вашего провайдера идентификации (IdP), используя OIDC / OAuth 2.0, с экраном согласия для авторизации пользователя.',
  ...
  permissions: {
    ...
    permission_description_tips:
      'Когда MyEyesID используется в качестве поставщика идентификации (IdP) для аутентификации в сторонних приложениях, и пользователи запрашивают авторизацию, данное описание отображается на экране согласия.',
  ...
  saml_idp_name_id_format: {
    ...
    persistent_description: 'Использовать ID пользователя MyEyesID как идентификатор имени',
    transient: 'Временный',
    transient_description: 'Использовать одноразовый ID пользователя как идентификатор имени',
    unspecified: 'Неопределенный',
    unspecified_description: 'Использовать ID пользователя MyEyesID как идентификатор имени',
