const connector_details = {
  ...
  test_sender_description:
    'MyEyesID использует шаблон "Общий" для тестирования. Вы получите сообщение, если ваш коннектор правильно настроен.',
  ...
  myeyesid_email: {
    ...
    total_email_sent_tip:
      'MyEyesID использует SendGrid для безопасной и стабильной встроенной электронной почты. Полностью бесплатно. <a>Узнать больше</a>',
    ...
    test_notes: 'MyEyesID использует шаблон "Общий" для тестирования.',
  },
  google_one_tap: {
