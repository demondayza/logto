const paywall = {
  ...
  scopes_per_resource_other:
    '{{count, number}}の<planName/> APIリソースあたりの許可制限に達しました。拡張するには今すぐアップグレードしてください。<a>お問い合わせ</a>は何かお手伝いが必要な場合はお気軽にどうぞ。',
  custom_domain:
    '<planName/>の{{count, number}}個のカスタムドメイン制限に達しました。有料プランにアップグレードして、複数のカスタムドメインとプレミアム特典を追加してください。ご質問がある場合は、お気軽に<a>お問い合わせ</a>ください。',
  ...
  passkey_sign_in:
    'パスキー サインイン機能とプレミアム特典を利用するには、有料プランにアップグレードしてください。ご不明な点があればお気軽に <a>お問い合わせください</a>。',
};
