const api_resource_details = {
  ...
  management_api_settings_description:
    'MyEyesID管理APIは、管理者が幅広いID関連タスクを管理し、セキュリティポリシーを強制し、規制や標準に準拠するための包括的なAPIのコレクションです。',
  management_api_notice:
    'この API は MyEyesID エンティティを表しており、変更や削除はできません。MyEyesID 管理 API を呼び出すには、マシン間アプリケーションを作成してください。 <a>詳細はこちら</a>',
