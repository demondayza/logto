const get_started = {
  ...
  subtitle: "MyEyesID'nun değerini hızla elde etmek için yapabileceğiniz birkaç şey",
  develop: {
  ...
  customize: {
    ...
    preview: {
      ...
      subtitle: 'Nasıl çalıştığını görmek için şimdi MyEyesID oturum açma deneyimini deneyin',
    },
    connector: {
      title:
