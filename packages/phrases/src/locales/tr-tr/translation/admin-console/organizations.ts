const organizations = {
  ...
  guide: {
    ...
    introduction: {
      title: "MyEyesID'da kuruluşun nasıl çalıştığını anlayalım",
      section_1: {
      ...
      section_2: {
        ...
        description:
          'Çok kiracılı SaaS uygulamalarında, birden çok kuruluş genellikle aynı erişim kontrol şablonunu paylaşır; bu şablon izinleri ve rolleri içerir. MyEyesID\'da buna "kuruluş şablonu" diyoruz.',
      ...
      section_3: {
        ...
        description:
          'Evet, API izinlerini organizasyon rollerine atayabilirsiniz. MyEyesID, organizasyonunuzun rollerini etkili bir şekilde yönetme esnekliği sunar, bu roller içinde hem organizasyon izinlerini hem de API izinlerini içerecek şekilde izin verir.',
      },
      section_4: {
