const webhook_details = {
  ...
  settings: {
    ...
    settings_description:
      'Webhooklar, belirli olaylarla ilgili gerçek zamanlı güncellemeleri almanızı sağlar, sağladıkları POST isteği MyEyesID’daki uç nokta URL’nize göndererek. Bu, yeni alınan bilgilere dayalı hemen harekete geçmenizi sağlar.',
    events: 'Olaylar',
    events_description: 'MyEyesID’nun POST isteğini göndereceği tetikleyici olayları seçin.',
    name: 'İsim',
    endpoint_url: 'Uç nokta URL’si',
    signing_key: 'İmza anahtarı',
    signing_key_tip:
      'Webhook’un yükü için kimliğinin doğruluğunu sağlamak için MyEyesID tarafından sağlanan gizli anahtarın istek başlığı olarak uç noktanızda ekleyin.',
