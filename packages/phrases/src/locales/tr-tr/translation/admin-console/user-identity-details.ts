const user_identity_details = {
  ...
  delete_tokens: {
    ...
    confirmation_message:
      'Belirteçleri silmek istediğinizden emin misiniz? MyEyesID Gizli Kasa saklanan {{connectorName}} erişim ve yenileme belirteçlerini kaldıracaktır. Bu kullanıcı, {{connectorName}} API erişimini geri yüklemek için yeniden yetkilendirmelidir.',
  },
