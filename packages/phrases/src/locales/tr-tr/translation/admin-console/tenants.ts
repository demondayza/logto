const tenants = {
  ...
  settings: {
    ...
    tenant_instance_description:
      "Kiracınızın nerede barındırılacağını seçin. Genel paylaşımlı altyapı için MyEyesID Cloud'u veya özel kaynaklar için özel bir örneği seçin.",
    ...
    enterprise_sso_description:
      'Ücretli planlarda kullanılabilir. Tüm üyelerin kuruluşunuzun kimlik sağlayıcısını kullanarak MyEyesID Cloud Konsoluna giriş yapabilmesi için Enterprise SSO etkinleştirmek üzere bizimle iletişime geçin.',
  },
  full_env_tag: {
  ...
  create_modal: {
    ...
    tenant_id_tip:
      'Kiracı kimliğini özelleştirin. Boş bırakılırsa, MyEyesID varsayılan bir kimlik oluşturur. Kiracı kimliği oluşturulduktan sonra değiştirilemez.',
  },
  ...
  tenant_landing_page: {
    ...
    description:
      'MyEyesID ile projenizi yapılandırmaya başlamak için lütfen yeni bir kiracı oluşturun. Hesabınızdan çıkış yapmanız veya hesabınızı silmeniz gerekiyorsa, sağ üst köşedeki avatar düğmesine tıklayın.',
