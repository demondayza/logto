const domain = {
  ...
  update_endpoint_notice:
    'Özellikleri için özel bir alan adı kullanmak istiyorsanız, uygulamanızda Sosyal bağlayıcı geri çağrı URI ve MyEyesID uç noktası için alan adını güncellemeyi unutmayın.',
  error_hint:
  ...
  custom: {
    ...
    deletion: {
      ...
      in_used_tip:
        'Bu özel alan adını önce sosyal bağlantı sağlayıcınızda veya uygulama uç noktasında yapılandırdıysanız, URI\'yi önce MyEyesID varsayılan alan adı olan "<span>{{domain}}</span>" olarak değiştirmeniz gerekir. Bu, sosyal giriş düğmesinin düzgün çalışması için gereklidir.',
  ...
  default: {
    ...
    default_domain_description:
      'MyEyesID, ek bir yapılandırma olmadan kullanıma hazır önceden yapılandırılmış bir varsayılan alan adı sunar. Bu varsayılan alan adı, özel bir alan adı etkinleştirdiyseniz bile yedek seçeneği olarak hizmet verir.',
    default_domain_field: 'MyEyesID varsayılan alan adı',
  },
