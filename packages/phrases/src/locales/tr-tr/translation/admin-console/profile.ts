const profile = {
  ...
  delete_account: {
    ...
    p: {
      ...
      remove_all_data:
        "Hesabını silmek, MyEyesID Cloud'daki tüm verilerini kalıcı olarak silecektir. Bu yüzden devam etmeden önce önemli verilerini yedeklediğinden emin ol.",
      confirm_information:
    ...
    try_again_later:
      'Lütfen daha sonra tekrar deneyin. Sorun devam ederse, lütfen istek kimliğiyle MyEyesID ekibiyle iletişime geçin.',
