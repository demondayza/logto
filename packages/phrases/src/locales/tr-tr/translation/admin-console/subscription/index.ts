...
const subscription = {
  ...
  free_plan_description:
    'Yan projeler ve başlangıç MyEyesID denemeleri için. Kredi kartı gerektirmez.',
  pro_plan: 'Pro plan',
  pro_plan_description: "Endişesiz bir şekilde MyEyesID'dan faydalanan işletmeler için.",
  ...
  payment_error:
    'Ödeme hatası tespit edildi. Önceki döngü için ${{price, number}} işlenemedi. MyEyesID hizmeti askıya alınmasını önlemek için ödemeleri güncelleyin.',
  downgrade: 'Düşür',
  current: 'Mevcut',
  upgrade: 'Yükselt',
  quota_table,
  ...
  not_eligible_modal: {
    ...
    upgrade_description:
      "Şu anda <name /> tarafından izin verilenden daha fazlasını kullanıyorsunuz. MyEyesID artık resmi olarak kullanılabilir durumda ve her plana özel özellikler sunuyor. <name />'e yükseltmeyi düşünmeden önce, yükseltme öncesinde aşağıdaki kriterleri karşıladığınızdan emin olun.",
  ...
  token_usage_notification: {
    ...
    close_to_limit:
      "Token kullanım sınırınıza yaklaştınız. Kullanımınız %100'ü aşarsa MyEyesID token vermeyi durduracak. Herhangi bir sorun yaşamamak için Ücretsiz planı yükseltin.",
    dev_plan_exceeded:
      "Bu tenant, MyEyesID'nun varlık limit politikası gereği token limitine ulaştı.",
  },
};
