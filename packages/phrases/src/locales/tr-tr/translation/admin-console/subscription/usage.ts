const usage = {
  ...
  mau: {
    title: 'MAU',
    tooltip:
      'Bir MAU, bir faturalandırma döngüsü içinde MyEyesID ile en az bir token değiştirmiş benzersiz bir kullanıcıdır. Pro Plan için sınırsızdır. <a>Daha fazla bilgi edin</a>',
    tooltip_for_enterprise:
      'Bir MAU, MyEyesID ile bir faturalandırma döngüsü içinde en az bir token değiştirmiş benzersiz bir kullanıcıdır. Kurumsal Plan için sınırsızdır.',
  },
  organizations: {
