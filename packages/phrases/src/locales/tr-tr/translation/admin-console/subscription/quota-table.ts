const quota_table = {
  ...
  mau_tip:
    'MAU (aylık aktif kullanıcı) MyEyesID ile en az bir jeton değiştirmiş olan benzersiz kullanıcı sayısını ifade eder.',
  tokens_tip:
    'MyEyesID tarafından ihraç edilen erişim tokeni, yenileme tokeni vb. dahil olmak üzere tüm token türleri.',
  mao_tip:
  ...
  third_party_tip:
    "MyEyesID'yu üçüncü taraf uygulama oturum açma ve izin verme için OIDC kimlik sağlayıcısı olarak kullanın.",
