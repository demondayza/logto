const application_details = {
  ...
  settings_description:
    '"Uygulama", kullanıcı bilgilerine erişebilen veya bir kullanıcı adına işlem yapabilen kayıtlı yazılım ya da hizmettir. Uygulamalar, MyEyesID\'nun kimin ne talep ettiğini anlamasına yardımcı olur ve oturum açma ile izin süreçlerini yönetir. Kimlik doğrulaması için gerekli alanları doldurun.',
  integration: 'Entegrasyon',
  integration_description:
    "Cloudflare'ın kenar ağı tarafından desteklenen ve dünya çapında en üst düzey performans ve 0ms soğuk başlangıçlarla MyEyesID güvenli çalışanlarla dağıtım yapın.",
  ...
  rotate_refresh_token_label:
    "Bu seçenek etkinleştirildiğinde, MyEyesID Yenileme Belirteği Bitiş Süresinin %70'i geçildiğinde veya belirli koşullar sağlandığında yeni bir Yenileme Belirteği verecektir. <a>Daha fazlası için tıklayın</a>",
  rotate_refresh_token_label_for_public_clients:
    'Etkinleştirildiğinde, MyEyesID her belirteç isteğinde yeni bir yenileme belirteci verecektir. <a>Daha fazlasını öğrenin</a>',
  ...
  app_domain_description_1:
    '{{domain}} destekli MyEyesID ile alanınızı özgürce kullanın, bu sürekli geçerlidir.',
  ...
  third_party_settings_description:
    "MyEyesID'yu Kimlik Sağlayıcı (IdP) olarak kullanarak üçüncü taraf uygulamaları OIDC / OAuth 2.0 ile entegre edin ve kullanıcı yetkilendirmesi için bir izin ekranı özelliği bulunmaktadır.",
  ...
  permissions: {
    ...
    permission_description_tips:
      'MyEyesID, üçüncü taraf uygulamalar için kimlik sağlayıcı (IdP) olarak kullanıldığında ve kullanıcılardan yetkilendirme istendiğinde, bu açıklama açıklama ekranında görünür.',
  ...
  saml_idp_name_id_format: {
    ...
    persistent: 'Kalıcı',
    persistent_description: 'MyEyesID kullanıcı kimliğini Ad ID olarak kullan',
    transient: 'Geçici',
    transient_description: 'Tek kullanımlık kullanıcı kimliğini Ad ID olarak kullan',
    unspecified: 'Belirtilmemiş',
    unspecified_description: 'MyEyesID kullanıcı kimliğini Ad ID olarak kullan',
