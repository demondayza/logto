...
- 2cbc591ff: carry over search params to the authentication request
  ...
  When entering the MyEyesID demo app with search parameters, if the user is not authenticated, the search parameters are now carried over to the authentication request. This allows manual testing of the OIDC authentication flow with specific parameters.
...
**Note:** Version bump only for package @myeyesid/demo-app
...
- **demo-app:** hide username if not exists ([#1644](https://github.com/myeyesid-io/myeyesid/issues/1644)) ([8b30f97](https://github.com/myeyesid-io/myeyesid/commit/8b30f974bfa4fa9c1aa43d2bcc22779a454905db))
...
- **demo-app:** username should not overflow info card ([#1498](https://github.com/myeyesid-io/myeyesid/issues/1498)) ([58558e5](https://github.com/myeyesid-io/myeyesid/commit/58558e50110349262c7a28f0195a7042f6fca732))
