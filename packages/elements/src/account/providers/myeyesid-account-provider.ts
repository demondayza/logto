...
import { type MyEyesIDAccountApi } from '../api/index.js';
import { type UserProfile } from '../types.js';

export type MyEyesIDAccountContextType = {
  userProfile: UserProfile;
};

export const myeyesidAccountContext = createContext<MyEyesIDAccountContextType>('myeyesid-account-context');

const tagName = 'myeyesid-account-provider';
...
export class MyEyesIDAccountProvider extends LitElement {
  ...
  accountApi?: MyEyesIDAccountApi;

  @state()
  @provide({ context: myeyesidAccountContext })
  private accountContext?: MyEyesIDAccountContextType;
...
declare global {
  ...
  interface HTMLElementTagNameMap {
    [tagName]: MyEyesIDAccountProvider;
  }
}
