...
- 3ed4d0a91e: fix an issue that prevents MyEyesID Experience from working in Android 11 and some older browser versions
...
- d2468683c: remove the image element's `cross-origin="anonymous"` attribute.
  ...
  Since those image elements are only used for display purposes, MyEyesID does not need to access the image data, so the `cross-origin="anonymous"` attribute is not necessary.
...
- baa8577c4: migrate experience app using Experience API.
  ...
  Migrate experience app API requests from legacy [Interaction API](https://openapi.myeyesid.io/group/endpoint-interaction) to the new [Experience API](https://openapi.myeyesid.io/group/endpoint-experience), except the following endpoints:
...
- 5a7204571: skip non-object messages in the native environment
  ...
  Ideally, we should check the source of the message with MyEyesID-specific identifier in the
...
- 343b1090f: - Add Power By MyEyesID Signature to the main-flow pages
...
**Note:** Version bump only for package @myeyesid/ui

## [1.0.0-beta.11](https://github.com/myeyesid-io/myeyesid/compare/v1.0.0-beta.10...v1.0.0-beta.11) (2022-10-19)

### Features

- **ui:** add a11y support ([#2076](https://github.com/myeyesid-io/myeyesid/issues/2076)) ([2249d71](https://github.com/myeyesid-io/myeyesid/commit/2249d717a8928597d00c383c268d6fdc506ac437))
...
- **ui:** global confirm modal ([#2018](https://github.com/myeyesid-io/myeyesid/issues/2018)) ([f1ca49c](https://github.com/myeyesid-io/myeyesid/commit/f1ca49c89253daef8b47ec88e30f69df818374d1))
...
- **ui:** fix ut ([9ea6a8c](https://github.com/myeyesid-io/myeyesid/commit/9ea6a8c8e94e116d8efbbff63b39738162cbaec1))
- **ui:** revert color token changes in ui as it uses different design system ([489e2b3](https://github.com/myeyesid-io/myeyesid/commit/489e2b3a1129fbbf824955e4697c1d64ff294d95))

## [1.0.0-beta.10](https://github.com/myeyesid-io/myeyesid/compare/v1.0.0-beta.9...v1.0.0-beta.10) (2022-09-28)

### Features

- **ui:** add forget password flow ([#1952](https://github.com/myeyesid-io/myeyesid/issues/1952)) ([ba787b4](https://github.com/myeyesid-io/myeyesid/commit/ba787b434ba4dd43064c56115eabfdba9912f98a))
...
- **ui:** add reset password form ([#1964](https://github.com/myeyesid-io/myeyesid/issues/1964)) ([f97ec56](https://github.com/myeyesid-io/myeyesid/commit/f97ec56fbf169538cff5f8f23ed8bb67e9483b27))
...
- **ui:** align mobile input outline ([#1991](https://github.com/myeyesid-io/myeyesid/issues/1991)) ([c9ba198](https://github.com/myeyesid-io/myeyesid/commit/c9ba198b59ae52d3c5b4520a98864519d7a756f7))
...
- **ui:** add sandbox props to iframe ([#1757](https://github.com/myeyesid-io/myeyesid/issues/1757)) ([62d2afe](https://github.com/myeyesid-io/myeyesid/commit/62d2afe9579334547b7ff5b803299b89933a5bd8))
- **ui:** connector name should fallback to en ([#1718](https://github.com/myeyesid-io/myeyesid/issues/1718)) ([3af5b1b](https://github.com/myeyesid-io/myeyesid/commit/3af5b1b4250d6de6883b4c8a8b9f7cf4f9b12dab))
- **ui:** extract ReactModal elementApp and fix act warning in ut ([#1756](https://github.com/myeyesid-io/myeyesid/issues/1756)) ([0270bf1](https://github.com/myeyesid-io/myeyesid/commit/0270bf1be3a51d9b9f8ed84a0327c58ed8a1bd4d))
- **ui:** fix ui test ([e4629f2](https://github.com/myeyesid-io/myeyesid/commit/e4629f2a5fd26a1d8eaefd04042eaeb5563ec30c))
...
- **ui:** fix some firefox standout bug ([#1615](https://github.com/myeyesid-io/myeyesid/issues/1615)) ([4ce6bd8](https://github.com/myeyesid-io/myeyesid/commit/4ce6bd8cf5c5953d9f62878ab2ea6ede74f6ca48))
- **ui:** protect window.location xss ([#1639](https://github.com/myeyesid-io/myeyesid/issues/1639)) ([34b465c](https://github.com/myeyesid-io/myeyesid/commit/34b465c7d83999e2215ef83555b64e38778b8b49))
- **ui:** should clear prev passcode input when click on backspace ([#1660](https://github.com/myeyesid-io/myeyesid/issues/1660)) ([7dfbc30](https://github.com/myeyesid-io/myeyesid/commit/7dfbc300b09cc3dac2a06176bf2cbc9f338d857e))

## [1.0.0-beta.1](https://github.com/myeyesid-io/myeyesid/compare/v1.0.0-beta.0...v1.0.0-beta.1) (2022-07-19)

### Features

- **ui:** add submit input to all the sign-in & register forms ([#1587](https://github.com/myeyesid-io/myeyesid/issues/1587)) ([0c0c83c](https://github.com/myeyesid-io/myeyesid/commit/0c0c83cc8f78f611f5a8527ecedd6ce21d1dad80))

### Bug Fixes

- **ui:** fix no-restrict-syntax in ui ([#1559](https://github.com/myeyesid-io/myeyesid/issues/1559)) ([816ce9f](https://github.com/myeyesid-io/myeyesid/commit/816ce9f903fc939b676165c5ad7e17c72f4c1c86))
- **ui:** format phone number with country calling code ([#1551](https://github.com/myeyesid-io/myeyesid/issues/1551)) ([c6384be](https://github.com/myeyesid-io/myeyesid/commit/c6384bed84340909aaa41f10abaea26b5195e6a5))
...
- **ui:** fix multiple libphonmenumber packed bug ([#1544](https://github.com/myeyesid-io/myeyesid/issues/1544)) ([e06f8d0](https://github.com/myeyesid-io/myeyesid/commit/e06f8d027eaea3ab89b4fd301be46af3508b61b5))

## [1.0.0-alpha.4](https://github.com/myeyesid-io/myeyesid/compare/v1.0.0-alpha.3...v1.0.0-alpha.4) (2022-07-08)

### Bug Fixes

- **ui:** add form submit event ([#1489](https://github.com/myeyesid-io/myeyesid/issues/1489)) ([f52fa58](https://github.com/myeyesid-io/myeyesid/commit/f52fa5891d70bf9a50c76eb3efa35f6031dc88cb))
...
- **ui:** dark mode seed ([#1426](https://github.com/myeyesid-io/myeyesid/issues/1426)) ([be73dbf](https://github.com/myeyesid-io/myeyesid/commit/be73dbf4ef14cf49779775dd95848ba73904a4b2))
...
- **demo-app:** show notification in main flow ([#1038](https://github.com/myeyesid-io/myeyesid/issues/1038)) ([90ca76e](https://github.com/myeyesid-io/myeyesid/commit/90ca76eeb5460b66d2241f137f179bf4d5d6ae37))
- **ui:** add bind social account flow ([#671](https://github.com/myeyesid-io/myeyesid/issues/671)) ([5e251bd](https://github.com/myeyesid-io/myeyesid/commit/5e251bdc0818195d7eb104488bdb8a3194205bdd))
- **ui:** add darkmode logo ([#880](https://github.com/myeyesid-io/myeyesid/issues/880)) ([9fa13a2](https://github.com/myeyesid-io/myeyesid/commit/9fa13a24ae2e1b3024b3ef2169736d27847f04eb))
- **ui:** add global primary color settings ([#871](https://github.com/myeyesid-io/myeyesid/issues/871)) ([0f2827c](https://github.com/myeyesid-io/myeyesid/commit/0f2827ccb873bf30e44209da39803ac6cc839af2))
...
- **ui:** add native sdk guard logic ([#1096](https://github.com/myeyesid-io/myeyesid/issues/1096)) ([147775a](https://github.com/myeyesid-io/myeyesid/commit/147775a8f45dbb5bbf05b3bf1b7c11c0a8acf4a4))
...
- **ui:** add social dropdown list for desktop ([#834](https://github.com/myeyesid-io/myeyesid/issues/834)) ([36922b3](https://github.com/myeyesid-io/myeyesid/commit/36922b343f06daa1c7d4125bd0066ec06962123d))
...
- **ui:** init destop styling foundation ([#787](https://github.com/myeyesid-io/myeyesid/issues/787)) ([5c02ec3](https://github.com/myeyesid-io/myeyesid/commit/5c02ec3bdae162bd83d26c56f7ae34ee6e505ca2))
...
- **ui:** add body background color ([#831](https://github.com/myeyesid-io/myeyesid/issues/831)) ([be8b862](https://github.com/myeyesid-io/myeyesid/commit/be8b8628ba345bd8f8832b2123a43e70c236406d))
- **ui:** add default success true for no response api ([#842](https://github.com/myeyesid-io/myeyesid/issues/842)) ([88600c0](https://github.com/myeyesid-io/myeyesid/commit/88600c012c892c969f1e5df7ec5f46874513a058))
...
- **ui:** fix callback link params for apple ([#985](https://github.com/myeyesid-io/myeyesid/issues/985)) ([362c3a6](https://github.com/myeyesid-io/myeyesid/commit/362c3a6e6ed3cab24a85f9e268509d31430609e4))
- **ui:** fix ci fail ([#708](https://github.com/myeyesid-io/myeyesid/issues/708)) ([da49812](https://github.com/myeyesid-io/myeyesid/commit/da4981216452ee11cf91c8f52a1d50ef18f9a37f))
- **UI:** fix connector target and id used in UI ([#838](https://github.com/myeyesid-io/myeyesid/issues/838)) ([cd46505](https://github.com/myeyesid-io/myeyesid/commit/cd4650508f9b1b4d2051e600afdf1e157dcf0631))
...
- **ui:** fix create account page reload issue ([#832](https://github.com/myeyesid-io/myeyesid/issues/832)) ([e221758](https://github.com/myeyesid-io/myeyesid/commit/e2217584a40098d6bfcd6a745e8e0d982e8936c0))
- **ui:** fix drawer overflow bug ([#984](https://github.com/myeyesid-io/myeyesid/issues/984)) ([b9131e9](https://github.com/myeyesid-io/myeyesid/commit/b9131e97659dece341ba4dd0cb47686a24698dcb))
- **ui:** fix social bug ([#939](https://github.com/myeyesid-io/myeyesid/issues/939)) ([7a17d41](https://github.com/myeyesid-io/myeyesid/commit/7a17d41acf7cc068d0ec5568bcd842db51aa8b39))
- **ui:** fix social native interaction bug ([#772](https://github.com/myeyesid-io/myeyesid/issues/772)) ([2161856](https://github.com/myeyesid-io/myeyesid/commit/2161856bcd33b66c8390b343cc3591ff284be286))
- **ui:** fix some of the bug bash issues ([#1053](https://github.com/myeyesid-io/myeyesid/issues/1053)) ([db1b6d2](https://github.com/myeyesid-io/myeyesid/commit/db1b6d247a3d07f81ff1284b1fdbd3e7ffcc97aa))
- **ui:** fix typo ([#792](https://github.com/myeyesid-io/myeyesid/issues/792)) ([13cd2c1](https://github.com/myeyesid-io/myeyesid/commit/13cd2c100ed32b40da72364d1f4685edd7d6d25a))
- **ui:** fix ui i18n package error ([#713](https://github.com/myeyesid-io/myeyesid/issues/713)) ([34d798b](https://github.com/myeyesid-io/myeyesid/commit/34d798b645f16aff05b3818797b7914b5d2bc9b3))
- **ui:** fix undefined dark-primary-color bug ([#876](https://github.com/myeyesid-io/myeyesid/issues/876)) ([542d878](https://github.com/myeyesid-io/myeyesid/commit/542d878231b98710af6e5a8ba6a5a5f74eee73a3))
- **ui:** hide social signin method if connectors are empty ([#909](https://github.com/myeyesid-io/myeyesid/issues/909)) ([5e0c39e](https://github.com/myeyesid-io/myeyesid/commit/5e0c39e5166072c2c8d729c2e0f714507fd93ba6))
- **ui:** input fields ([#1125](https://github.com/myeyesid-io/myeyesid/issues/1125)) ([20f7ad9](https://github.com/myeyesid-io/myeyesid/commit/20f7ad986353eb0026cbec417eaed3c334279f86))
- **ui:** relocate svg jest config ([#856](https://github.com/myeyesid-io/myeyesid/issues/856)) ([d8c62c1](https://github.com/myeyesid-io/myeyesid/commit/d8c62c14a677d9afa8ce4b2c78cdd8fc8b1ee6c1))
- **ui:** social bind account should back to sign-in page ([#952](https://github.com/myeyesid-io/myeyesid/issues/952)) ([da41369](https://github.com/myeyesid-io/myeyesid/commit/da41369bfd0e444190d33edef6527b32b538dbee))
...
- **ut:** fix ut ([#683](https://github.com/myeyesid-io/myeyesid/issues/683)) ([b0138bd](https://github.com/myeyesid-io/myeyesid/commit/b0138bdc0f2c43f40e20e83b621f3de3d068c171))
