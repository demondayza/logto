...
<img alt="MyEyesID sign-in experience" src={myeyesidSignInExperience} width="560" style={{ borderRadius: '6px' }} />

If everything is configured correctly, once you complete the sign-in or registration process in MyEyesID, you will be redirected back to ChatGPT. From now on, every request sent by ChatGPT to your plugin server will carry the Authorization header, allowing you to decode and verify the token in your API.
