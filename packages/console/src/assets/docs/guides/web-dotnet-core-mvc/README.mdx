...
<Step title="Add MyEyesID SDK as a dependency">

<Installation />

</Step>

<Step title="Add MyEyesID authentication">
...
public class HomeController : Controller
{
  ...
  {
    // This will redirect the user to the MyEyesID sign-in page.
  ...
  {
    // This will clear the authentication cookie and redirect the user to the MyEyesID sign-out page
    // to clear the MyEyesID session as well.
