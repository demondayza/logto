...
<InlineNotification>
  ...
  you DO NOT need to add additional libraries from MyEyesID to integrate.
...
All the MyEyesID Authorization server configurations can be found by requesting{' '}
...
- `spring.security.oauth2.resourceserver.jwt.issuer-uri`: The iss claim value and the issuer URI in the JWT issued by MyEyesID.
...
package io.myeyesid.springboot.sample.validator;
...
package io.myeyesid.springboot.sample.configuration;

import com.nimbusds.jose.JOSEObjectType;
import com.nimbusds.jose.proc.DefaultJOSEObjectTypeVerifier;
import com.nimbusds.jose.proc.SecurityContext;
import io.myeyesid.springboot.sample.validator.AudienceValidator;
...
public class SecurityConfiguration {
    ...
    public JwtDecoder jwtDecoder() {
        NimbusJwtDecoder jwtDecoder = NimbusJwtDecoder.withJwkSetUri(jwksUri)
                // MyEyesID uses the ES384 algorithm to sign the JWTs by default.
                .jwsAlgorithm(ES384)
...
package io.myeyesid.springboot.sample.controller;
...
- [Protect your API](https://docs.myeyesid.io/docs/recipes/protect-your-api/)
