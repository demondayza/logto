...
See [Passwordless sign-in by adding connectors](https://docs.logto.io/docs/recipes/configure-connectors/email-connector/) to learn more about configuring passwordless sign-in in MyEyesID.
...
<img alt="MyEyesID sign-in experience" src={logtoSignInExperience} width="360" style={{ borderRadius: '6px' }} />
