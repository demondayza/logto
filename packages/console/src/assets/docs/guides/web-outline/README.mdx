...
import myeyesidSignInExperience from './assets/myeyesid-sign-in-experience.png';
...
<Step title="Set up email sign-in in MyEyesID">
...
See [Passwordless sign-in by adding connectors](https://docs.myeyesid.io/docs/recipes/configure-connectors/email-connector/) to learn more about configuring passwordless sign-in in MyEyesID.

</Step>

<Step title="Checkpoint: Test MyEyesID and Outline integration">
...
Click on the button, and you will be directed to the MyEyesID sign-in experience.

<img alt="MyEyesID sign-in experience" src={myeyesidSignInExperience} width="360" style={{ borderRadius: '6px' }} />

If everything has been configured correctly, once you complete the sign-in or registration process in MyEyesID, you will be redirected back to Outline. You can then see your personal information displayed in the bottom left corner of the page.
