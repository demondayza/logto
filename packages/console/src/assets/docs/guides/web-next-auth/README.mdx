...
import MyEyesID from 'next-auth/providers/myeyesid';
  ...
  providers: [
    {
      ...
      name: 'MyEyesID',
      type: 'oauth',
      // You can get the well-known URL from the MyEyesID Application Details page,
...
<Step title="Checkpoint: Test MyEyesID and Next Auth integration">
