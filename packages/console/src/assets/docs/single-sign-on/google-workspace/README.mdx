...
2. Enable **Store tokens for persistent API access** in MyEyesID Google connector. MyEyesID will securely [store Google access and refresh tokens in the Secret Vault](https://docs.logto.io/secret-vault/federated-token-set/token-retrieval).
