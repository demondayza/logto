...
describe('isGreaterThanCurrentVersion', () => {
  it('should return true if the target version is greater than the current MyEyesID version', () => {
  ...
  it('should return false if the target version is less than the current MyEyesID version', () => {
  ...
  it('should return false if the target version is equal to the current MyEyesID version', () => {
