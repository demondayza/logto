...
The official MyEyesID connector for AWS connector for direct mail service.
...
MyEyesID team to call the Amazon Simple Email Service APIs, with the help of which MyEyesID end-users can register and sign in to their MyEyesID account via mail verification code.
...
2. Complete the settings of the `Amazon Simple Email Service` connector:
   ...
   - `emailAddress`: The email address you use to send mail, in the format of `MyEyesID<noreply@myeyesid.io>` or `<noreply@myeyesid.io>`
