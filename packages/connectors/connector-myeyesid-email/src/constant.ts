...
export const defaultMetadata: ConnectorMetadata = {
  id: 'myeyesid-email',
  target: 'myeyesid-email',
  platform: null,
  name: {
    en: 'MyEyesID email service',
    de: 'MyEyesID e-mail-dienst',
    es: 'Servicio de correo electrónico de MyEyesID',
    fr: 'Service de messagerie électronique MyEyesID',
    it: 'Servizio di posta elettronica MyEyesID',
    ja: 'MyEyesID メールサービス',
    ko: 'MyEyesID 이메일 서비스',
    'pl-PL': 'Usługa poczty elektronicznej MyEyesID',
    'pt-BR': 'Serviço de e-mail do MyEyesID',
    'pt-PT': 'Serviço de email do MyEyesID',
    ru: 'Сервис электронной почты MyEyesID',
    'tr-TR': 'MyEyesID e-posta hizmeti',
    'zh-CN': 'MyEyesID 邮件服务',
    'zh-HK': 'MyEyesID 電郵服務',
    'zh-TW': 'MyEyesID 電子郵件服務',
  },
  logo: './logo.svg',
   ...
   */
  fromEmail: 'no-reply@myeyesid.email',
};
