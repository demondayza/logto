...
type InferSchema<T> =
  T extends TableInfo<infer _, infer _, Extract<keyof (infer Schema), string>, infer Schema>
    ? Schema
    : never;
 ...
 * interface. The generated schemas in `@myeyesid/schemas` satisfy this interface.
 *
