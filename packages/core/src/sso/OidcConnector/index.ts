...
import { type ExtendedSocialUserInfo } from '@myeyesid/schemas';
...
class OidcConnector {
   ...
   * @param oidcQueryParams.state The state generated by MyEyesID experience client
