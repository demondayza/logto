...
export class SamlSsoConnector extends SamlConnector implements SingleSignOn {
   ...
   * @param state The state generated by MyEyesID experience client.
   * @param setSession Set the connector session data to the oidc provider session storage. @see @myeyesid/connector-kit
   */
