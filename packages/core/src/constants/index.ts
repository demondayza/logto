...
export const idpInitiatedSamlSsoSessionCookieName = '_myeyesid_idp_saml_sso_session_id';
export const spInitiatedSamlSsoSessionCookieName = '_myeyesid_sp_saml_sso_session_id';
