...
import type { SendMessagePayload, TemplateType } from '@myeyesid/connector-kit';
import { templateTypeGuard, ConnectorError, ConnectorErrorCodes } from '@myeyesid/connector-kit';
import {
